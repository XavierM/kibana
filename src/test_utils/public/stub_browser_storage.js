...
class StubBrowserStorage {
    constructor() {
        this.keys = [];
        this.values = [];
        this.size = 0;
        this.sizeLimit = 5000000; // 5mb, minimum browser storage size;
    }
    // -----------------------------------------------------------------------------------------------
...
exports.StubBrowserStorage = StubBrowserStorage;
