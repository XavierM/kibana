...
exports.oneTermOneHistogramBucketWithTwoMetricsOneTopHitOneDerivative = {
    hits: { total: 1000, hits: [], max_score: 0 },
    aggregations: {
        agg_3: {
            buckets: [
