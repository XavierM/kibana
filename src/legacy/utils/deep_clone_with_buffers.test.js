...
const deep_clone_with_buffers_1 = require("./deep_clone_with_buffers");
describe('deepCloneWithBuffers()', () => {
    it('deep clones objects', () => {
        ...
        const output = deep_clone_with_buffers_1.deepCloneWithBuffers(source);
    ...
    it('copies buffers but keeps them buffers', () => {
        ...
        const output = deep_clone_with_buffers_1.deepCloneWithBuffers(input);
