...
function extractTimeFields(fields) {
    ...
    const label = i18n_1.i18n.translate('kbn.management.createIndexPattern.stepTime.noTimeFieldsLabel', {
    ...
    const noTimeFieldLabel = i18n_1.i18n.translate('kbn.management.createIndexPattern.stepTime.noTimeFieldOptionLabel', {
