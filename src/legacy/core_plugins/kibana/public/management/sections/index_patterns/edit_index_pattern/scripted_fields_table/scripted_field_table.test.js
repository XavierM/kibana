...
describe('ScriptedFieldsTable', () => {
    ...
    test('should render normally', async () => {
        const component = enzyme_1.shallow(react_1.default.createElement(scripted_fields_table_1.ScriptedFieldsTable, { indexPattern: indexPattern, helpers: helpers }));
    ...
    test('should filter based on the lang filter', async () => {
        const component = enzyme_1.shallow(react_1.default.createElement(scripted_fields_table_1.ScriptedFieldsTable, { indexPattern: getIndexPatternMock({
                getScriptedFields: () => [
                    { name: 'ScriptedField', lang: 'painless', script: 'x++' },
                    { name: 'JustATest', lang: 'painless', script: 'z++' },
    ...
    test('should delete a field', async () => {
        ...
        const component = enzyme_1.shallow(react_1.default.createElement(scripted_fields_table_1.ScriptedFieldsTable, { indexPattern: {
                ...indexPattern,
                removeScriptedField,
            }, helpers: helpers }));
        await component.update(); // Fire `componentWillMount()`
