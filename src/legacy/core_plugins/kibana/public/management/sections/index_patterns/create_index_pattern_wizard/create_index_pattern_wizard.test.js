...
const create_index_pattern_wizard_1 = require("./create_index_pattern_wizard");
...
const { savedObjects, overlays, uiSettings } = mocks_1.coreMock.createStart();
const { indexPatterns, search } = mocks_2.dataPluginMock.createStartContract();
...
describe('CreateIndexPatternWizard', () => {
    test(`defaults to the loading state`, () => {
        const component = enzyme_1.shallow(react_1.default.createElement(create_index_pattern_wizard_1.CreateIndexPatternWizard, { initialQuery: initialQuery, services: services }));
