...
const step_time_field_1 = require("../step_time_field");
...
jest.mock('./../../lib', () => ({
    ...
    ensureMinimumTime: async (fields) => Promise.resolve(fields),
}));
jest.mock('ui/chrome', () => ({
    addBasePath: () => { },
}));
...
describe('StepTimeField', () => {
    it('should render normally', () => {
        const component = enzyme_helpers_1.shallowWithI18nProvider(react_1.default.createElement(step_time_field_1.StepTimeField, { indexPattern: "ki*", indexPatternsService: indexPatternsService, goToPreviousStep: noop, createIndexPattern: noop, indexPatternCreationType: mockIndexPatternCreationType }));
    ...
    it('should ensure disabled time field options work properly', () => {
        ...
        component.instance().onTimeFieldChanged({
    ...
    it('should remember error thrown by createIndexPatter() prop', async () => {
        ...
        const component = enzyme_helpers_1.shallowWithI18nProvider(react_1.default.createElement(step_time_field_1.StepTimeField, { indexPattern: "ki*", indexPatternsService: indexPatternsService, goToPreviousStep: noop, createIndexPattern: createIndexPattern, indexPatternCreationType: mockIndexPatternCreationType }));
    ...
    it('should call createIndexPattern with undefined time field when no time filter chosen', async () => {
        ...
        const component = enzyme_helpers_1.shallowWithI18nProvider(react_1.default.createElement(step_time_field_1.StepTimeField, { indexPattern: "ki*", indexPatternsService: indexPatternsService, goToPreviousStep: noop, createIndexPattern: createIndexPattern, indexPatternCreationType: mockIndexPatternCreationType }));
        await component.instance().fetchTimeFields();
        expect(component.state().timeFields).toHaveLength(3);
        component.instance().onTimeFieldChanged({
            target: { value: undefined },
        });
        await component.instance().createIndexPattern();
