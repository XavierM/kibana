...
const add_filter_1 = require("./add_filter");
describe('AddFilter', () => {
    test('should render normally', () => {
        const component = enzyme_1.shallow(react_1.default.createElement(add_filter_1.AddFilter, { onAddFilter: () => { } }));
        expect(component).toMatchSnapshot();
    });
    test('should allow adding a filter', async () => {
        const onAddFilter = jest.fn();
        const component = enzyme_1.shallow(react_1.default.createElement(add_filter_1.AddFilter, { onAddFilter: onAddFilter }));
