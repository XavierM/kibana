...
function DiscoverField({ field, indexPattern, onAddField, onRemoveField, onAddFilter, onShowDetails, showDetails, getDetails, selected, useShortDots, }) {
    const addLabel = i18n_1.i18n.translate('kbn.discover.fieldChooser.discoverField.addButtonLabel', {
        defaultMessage: 'Add',
    });
    const addLabelAria = i18n_1.i18n.translate('kbn.discover.fieldChooser.discoverField.addButtonAriaLabel', {
        defaultMessage: 'Add {field} to table',
        values: { field: field.name },
    });
    const removeLabel = i18n_1.i18n.translate('kbn.discover.fieldChooser.discoverField.removeButtonLabel', {
        defaultMessage: 'Remove',
    });
    const removeLabelAria = i18n_1.i18n.translate('kbn.discover.fieldChooser.discoverField.removeButtonAriaLabel', {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: `dscSidebarField dscSidebarItem ${showDetails ? 'dscSidebarItem--active' : ''}`, tabIndex: 0, onClick: () => onShowDetails(!showDetails, field), onKeyPress: () => onShowDetails(!showDetails, field), "data-test-subj": `field-${field.name}-showDetails` },
            ...
            react_1.default.createElement("span", { className: "dscSidebarField__name eui-textTruncate" },
                react_1.default.createElement(eui_1.EuiToolTip, { position: "top", content: field.name, delay: "long", anchorClassName: "eui-textTruncate" },
                    react_1.default.createElement(eui_1.EuiText, { size: "xs", "data-test-subj": `field-${field.name}`, className: "eui-textTruncate" }, useShortDots ? helpers_1.shortenDottedString(field.name) : field.displayName))),
