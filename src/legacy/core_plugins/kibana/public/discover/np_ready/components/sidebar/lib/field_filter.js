...
exports.getDefaultFieldFilter = getDefaultFieldFilter;
...
exports.setFieldFilterProp = setFieldFilterProp;
function isFieldFiltered(field, filterState, fieldCounts) {
    ...
    const scriptedOrMissing = !filterState.missing ||
        field.type === '_source' ||
        field.scripted ||
...
exports.isFieldFiltered = isFieldFiltered;
