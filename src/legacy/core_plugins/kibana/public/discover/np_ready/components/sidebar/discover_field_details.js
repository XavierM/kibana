...
function DiscoverFieldDetails({ field, indexPattern, details, onAddFilter, }) {
    ...
    return (react_1.default.createElement("div", { className: "dscFieldDetails" },
        !details.error && (react_1.default.createElement(eui_1.EuiText, { size: "xs" },
            react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.discover.fieldChooser.detailViews.topValuesInRecordsDescription", defaultMessage: "Top 5 values in" }),
            ' ',
            ...
            details.total,
            ' ',
            react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.discover.fieldChooser.detailViews.recordsText", defaultMessage: "records" }))),
        ...
        details.visualizeUrl && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(eui_1.EuiLink, { href: details.visualizeUrl, className: "kuiButton kuiButton--secondary kuiButton--small kuiVerticalRhythmSmall", "data-test-subj": `fieldVisualize-${field.name}` },
                react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.discover.fieldChooser.detailViews.visualizeLinkText", defaultMessage: "Visualize" }),
