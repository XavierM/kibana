...
function getComponent(selected = false, showDetails = false, useShortDots = false) {
    ...
    const comp = enzyme_helpers_1.mountWithIntl(react_1.default.createElement(discover_field_1.DiscoverField, Object.assign({}, props)));
    return { comp, props };
}
describe('discover sidebar field', function () {
    ...
    it('should trigger onShowDetails', function () {
        const { comp, props } = getComponent();
        test_1.findTestSubject(comp, 'field-bytes-showDetails').simulate('click');
