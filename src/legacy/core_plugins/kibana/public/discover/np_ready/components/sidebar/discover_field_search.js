...
function DiscoverFieldSearch({ onChange, value, types }) {
    const searchPlaceholder = i18n_1.i18n.translate('kbn.discover.fieldChooser.searchPlaceHolder', {
        defaultMessage: 'Search field names',
    });
    const aggregatableLabel = i18n_1.i18n.translate('kbn.discover.fieldChooser.filter.aggregatableLabel', {
        defaultMessage: 'Aggregatable',
    });
    const searchableLabel = i18n_1.i18n.translate('kbn.discover.fieldChooser.filter.searchableLabel', {
        defaultMessage: 'Searchable',
    });
    const typeLabel = i18n_1.i18n.translate('kbn.discover.fieldChooser.filter.typeLabel', {
        defaultMessage: 'Type',
    });
    ...
    const filterBtnAriaLabel = isPopoverOpen
        ? i18n_1.i18n.translate('kbn.discover.fieldChooser.toggleFieldFilterButtonHideAriaLabel', {
            defaultMessage: 'Hide field filter settings',
        })
        : i18n_1.i18n.translate('kbn.discover.fieldChooser.toggleFieldFilterButtonShowAriaLabel', {
    ...
    const buttonContent = (react_1.default.createElement(eui_1.EuiFacetButton, { "aria-label": filterBtnAriaLabel, "data-test-subj": "toggleFieldFilterButton", className: "dscFieldSearch__toggleButton", icon: react_1.default.createElement(eui_1.EuiIcon, { type: "filter" }), isSelected: activeFiltersCount > 0, quantity: activeFiltersCount, onClick: handleFacetButtonClicked },
        react_1.default.createElement(react_2.FormattedMessage, { id: "kbn.discover.fieldChooser.fieldFilterFacetButtonLabel", defaultMessage: "Filter by type" })));
    const select = (id, selectOptions, selectValue) => {
        return (react_1.default.createElement(eui_1.EuiSelect, { id: `${id}-select`, options: selectOptions, value: selectValue, onChange: (e) => handleValueChange(id, e.target.value), "aria-label": i18n_1.i18n.translate('kbn.discover.fieldChooser.filter.fieldSelectorLabel', {
        ...
        react_1.default.createElement("div", { className: "dscFieldSearch__filterWrapper" },
            react_1.default.createElement(eui_1.EuiOutsideClickDetector, { onOutsideClick: () => { }, isDisabled: !isPopoverOpen },
                react_1.default.createElement(eui_1.EuiPopover, { id: "dataPanelTypeFilter", panelClassName: "euiFilterGroup__popoverPanel", panelPaddingSize: "none", anchorPosition: "downLeft", display: "block", isOpen: isPopoverOpen, closePopover: () => {
                    ...
                    react_1.default.createElement(eui_1.EuiPopoverTitle, null, i18n_1.i18n.translate('kbn.discover.fieldChooser.filter.filterByTypeLabel', {
                        defaultMessage: 'Filter by type',
                    })),
                    selectionPanel,
                    react_1.default.createElement(eui_1.EuiPopoverFooter, null,
                        react_1.default.createElement(eui_1.EuiSwitch, { label: i18n_1.i18n.translate('kbn.discover.fieldChooser.filter.hideMissingFieldsLabel', {
