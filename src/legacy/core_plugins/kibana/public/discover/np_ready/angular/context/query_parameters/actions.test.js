...
let state;
let filterManager;
let filterManagerSpy;
beforeEach(() => {
    filterManager = new public_1.FilterManager(setupMock.uiSettings);
...
describe('context query_parameter actions', function () {
    describe('action addFilter', () => {
        it('should pass the given arguments to the filterManager', () => {
            const { addFilter } = actions_1.getQueryParameterActions(filterManager);
    ...
    describe('action setPredecessorCount', () => {
        it('should set the predecessorCount to the given value', () => {
            const { setPredecessorCount } = actions_1.getQueryParameterActions(filterManager);
    ...
    describe('action setSuccessorCount', () => {
        it('should set the successorCount to the given value', function () {
            const { setSuccessorCount } = actions_1.getQueryParameterActions(filterManager);
    ...
    describe('action setQueryParameters', function () {
        const { setQueryParameters } = actions_1.getQueryParameterActions(filterManager);
