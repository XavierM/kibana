...
describe('function extractNanos', function () {
    test('extract nanos of 2014-01-01', function () {
        expect(date_conversion_1.extractNanos('2014-01-01')).toBe('000000000');
    });
    test('extract nanos of 2014-01-01T12:12:12.234Z', function () {
        expect(date_conversion_1.extractNanos('2014-01-01T12:12:12.234Z')).toBe('234000000');
    });
    test('extract nanos of 2014-01-01T12:12:12.234123321Z', function () {
        expect(date_conversion_1.extractNanos('2014-01-01T12:12:12.234123321Z')).toBe('234123321');
    });
});
