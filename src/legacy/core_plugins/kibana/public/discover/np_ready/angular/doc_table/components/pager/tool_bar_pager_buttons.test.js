...
const tool_bar_pager_buttons_1 = require("./tool_bar_pager_buttons");
// @ts-ignore
...
test('it renders ToolBarPagerButtons', () => {
    ...
    const wrapper = enzyme_helpers_1.shallowWithIntl(react_1.default.createElement(tool_bar_pager_buttons_1.ToolBarPagerButtons, Object.assign({}, props)));
...
test('it renders ToolBarPagerButtons with clickable next and previous button', () => {
    ...
    const wrapper = enzyme_helpers_1.mountWithIntl(react_1.default.createElement(tool_bar_pager_buttons_1.ToolBarPagerButtons, Object.assign({}, props)));
    test_1.findTestSubject(wrapper, 'btnPrevPage').simulate('click');
    expect(props.onPagePrevious).toHaveBeenCalledTimes(1);
    test_1.findTestSubject(wrapper, 'btnNextPage').simulate('click');
