...
function TableHeaderColumn({ colLeftIdx, colRightIdx, displayName, isRemoveable, isSortable, name, onChangeSortOrder, onMoveColumn, onRemoveColumn, sortOrder, }) {
    ...
    const getSortButtonAriaLabel = () => {
        const sortAscendingMessage = i18n_1.i18n.translate('kbn.docTable.tableHeader.sortByColumnAscendingAriaLabel', {
            defaultMessage: 'Sort {columnName} ascending',
            values: { columnName: name },
        });
        const sortDescendingMessage = i18n_1.i18n.translate('kbn.docTable.tableHeader.sortByColumnDescendingAriaLabel', {
            defaultMessage: 'Sort {columnName} descending',
            values: { columnName: name },
        });
        const stopSortingMessage = i18n_1.i18n.translate('kbn.docTable.tableHeader.sortByColumnUnsortedAriaLabel', {
    ...
    const buttons = [
        ...
        // Remove Button
        {
            ...
            ariaLabel: i18n_1.i18n.translate('kbn.docTable.tableHeader.removeColumnButtonAriaLabel', {
            ...
            tooltip: i18n_1.i18n.translate('kbn.docTable.tableHeader.removeColumnButtonTooltip', {
        ...
        // Move Left Button
        {
            ...
            ariaLabel: i18n_1.i18n.translate('kbn.docTable.tableHeader.moveColumnLeftButtonAriaLabel', {
            ...
            tooltip: i18n_1.i18n.translate('kbn.docTable.tableHeader.moveColumnLeftButtonTooltip', {
        ...
        // Move Right Button
        {
            ...
            ariaLabel: i18n_1.i18n.translate('kbn.docTable.tableHeader.moveColumnRightButtonAriaLabel', {
            ...
            tooltip: i18n_1.i18n.translate('kbn.docTable.tableHeader.moveColumnRightButtonTooltip', {
                defaultMessage: 'Move column to the right',
            }),
        },
    ];
    return (react_1.default.createElement("th", { "data-test-subj": "docTableHeaderField" },
        react_1.default.createElement("span", { "data-test-subj": `docTableHeader-${name}` },
            displayName,
            buttons
                .filter(button => button.active)
                .map((button, idx) => (react_1.default.createElement(eui_1.EuiToolTip, { id: `docTableHeader-${name}-tt`, content: button.tooltip, key: `button-${idx}` },
                react_1.default.createElement("button", { "aria-label": button.ariaLabel, className: button.className, "data-test-subj": button.testSubject, onClick: button.onClick })))))));
}
