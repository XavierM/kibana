...
const doc_table_1 = require("./np_ready/angular/doc_table");
const table_header_1 = require("./np_ready/angular/doc_table/components/table_header");
const pager_1 = require("./np_ready/angular/doc_table/components/pager");
const table_row_1 = require("./np_ready/angular/doc_table/components/table_row");
const pager_factory_1 = require("./np_ready/angular/doc_table/lib/pager/pager_factory");
const infinite_scroll_1 = require("./np_ready/angular/doc_table/infinite_scroll");
const doc_viewer_1 = require("./np_ready/angular/doc_viewer");
const collapsible_sidebar_1 = require("./np_ready/angular/directives/collapsible_sidebar/collapsible_sidebar");
// @ts-ignore
const fixed_scroll_1 = require("./np_ready/angular/directives/fixed_scroll");
// @ts-ignore
const debounce_1 = require("./np_ready/angular/directives/debounce/debounce");
const render_complete_1 = require("./np_ready/angular/directives/render_complete");
const public_2 = require("../../../../../plugins/kibana_legacy/public");
const sidebar_1 = require("./np_ready/components/sidebar");
/**
...
function getInnerAngularModule(name, core, deps) {
    ...
    public_2.configureAppAngularModule(module, core, true);
    return module;
}
