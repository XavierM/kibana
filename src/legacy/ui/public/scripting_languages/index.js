...
exports.getEnabledScriptingLanguages = (http) => http.get('/api/kibana/scripts/languages').catch(() => {
    notify_1.toastNotifications.addDanger(i18n_1.i18n.translate('common.ui.scriptingLanguages.errorFetchingToastDescription', {
