...
const theme_test_mocks_1 = require("./theme.test.mocks");
const theme_1 = require("./theme");
function setup() {
    const brand$ = new Rx.BehaviorSubject({ logo: 'foo', smallLogo: 'foo' });
    theme_test_mocks_1.newPlatformChrome.getBrand$.mockReturnValue(brand$);
    const applicationClasses$ = new Rx.BehaviorSubject([]);
    theme_test_mocks_1.newPlatformChrome.getApplicationClasses$.mockReturnValue(applicationClasses$);
    const chrome = {};
    theme_1.initChromeThemeApi(chrome);
...
describe('setBrand', () => {
    it('proxies to newPlatformChrome', () => {
        ...
        expect(theme_test_mocks_1.newPlatformChrome.setBrand.mock.calls).toMatchInlineSnapshot(`
Array [
  Array [
    Object {
      "logo": "foo.svg",
...
describe('addApplicationClass', () => {
    it('proxies each class as a separate argument to newPlatformChrome', () => {
        ...
        expect(theme_test_mocks_1.newPlatformChrome.addApplicationClass.mock.calls).toMatchInlineSnapshot(`
Array [
  Array [
    "foo",
  ],
...
describe('removeApplicationClass', () => {
    it('proxies each class as a separate argument to newPlatformChrome', () => {
        ...
        expect(theme_test_mocks_1.newPlatformChrome.removeApplicationClass.mock.calls).toMatchInlineSnapshot(`
Array [
  Array [
    "foo",
  ],
