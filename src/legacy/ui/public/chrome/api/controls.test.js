...
const controls_test_mocks_1 = require("./controls.test.mocks");
const controls_1 = require("./controls");
function setup() {
    const isVisible$ = new Rx.BehaviorSubject(true);
    controls_test_mocks_1.newPlatformChrome.getIsVisible$.mockReturnValue(isVisible$);
    const chrome = {};
    controls_1.initChromeControlsApi(chrome);
...
describe('setVisible', () => {
    it('passes the visibility to the newPlatform', () => {
        ...
        chrome.setVisible(false);
        expect(controls_test_mocks_1.newPlatformChrome.setIsVisible.mock.calls).toMatchInlineSnapshot(`
Array [
  Array [
    true,
  ],
