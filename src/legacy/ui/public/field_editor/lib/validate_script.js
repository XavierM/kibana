...
exports.executeScript = async ({ name, lang, script, indexPatternTitle, query, additionalFields = [], getHttpStart, }) => {
...
exports.isScriptValid = async ({ name, lang, script, indexPatternTitle, getHttpStart, }) => {
    const scriptResponse = await exports.executeScript({
        name,
        lang,
        script,
        indexPatternTitle,
