...
class FieldFormatEditor extends react_1.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (react_1.default.createElement(react_1.Fragment, null, EditorComponent ? (react_1.default.createElement(EditorComponent, { fieldType: fieldType, format: fieldFormat, formatParams: fieldFormatParams, onChange: onChange, onError: onError })) : null));
    }
}
