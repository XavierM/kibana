...
const organize_by_1 = require("./organize_by");
describe('organizeBy', () => {
    test('it works', () => {
        const col = [
            {
        ...
        const resp = organize_by_1.organizeBy(col, 'roles');
    ...
    test('behaves just like groupBy in normal scenarios', () => {
        ...
        const orgs = organize_by_1.organizeBy(col, 'name');
        const groups = lodash_1.groupBy(col, 'name');
