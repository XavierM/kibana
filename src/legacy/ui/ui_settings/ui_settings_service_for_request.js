...
const ui_settings_service_factory_1 = require("./ui_settings_service_factory");
/**
...
function getUiSettingsServiceForRequest(server, request) {
    ...
    return ui_settings_service_factory_1.uiSettingsServiceFactory(server, { savedObjectsClient });
}
