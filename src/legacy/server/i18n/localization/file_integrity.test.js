...
require("./file_integrity.test.mocks");
...
describe('Integrity Hash', () => {
    it('creates a hash from a file given a file path', async () => {
        ...
        const integrityHash = await file_integrity_1.getIntegrityHash(filePath);
...
describe('Integrity Hashes', () => {
    it('returns an object with each filename and its hash', async () => {
        ...
        const integrityHashes = await file_integrity_1.getIntegrityHashes(filePaths);
