 ...
 * into the repository.
 */
async function generateNoticeFromSource({ productName, directory, log }) {
    ...
    const files = vinyl_fs_1.default.src(globs, options);
...
exports.generateNoticeFromSource = generateNoticeFromSource;
