...
function DefaultEditor({ vis, uiState, timeRange, filters, optionTabs, query, embeddableHandler, eventEmitter, linked, savedSearch, }) {
    ...
    return (react_1.default.createElement(public_1.PanelsContainer, { className: "visEditor--default", resizerClassName: `visEditor__resizer ${isCollapsed ? 'visEditor__resizer-isHidden' : ''}` },
        ...
        react_1.default.createElement(public_1.Panel, { className: `visEditor__collapsibleSidebar ${isCollapsed ? 'visEditor__collapsibleSidebar-isClosed' : ''}`, initialWidth: editorInitialWidth },
            react_1.default.createElement(sidebar_1.DefaultEditorSideBar, { isCollapsed: isCollapsed, onClickCollapse: onClickCollapse, optionTabs: optionTabs, vis: vis, uiState: uiState, isLinkedSearch: linked, savedSearch: savedSearch, timeRange: timeRange, eventEmitter: eventEmitter }))));
}
