...
const label = (react_1.default.createElement(react_1.default.Fragment, null,
    ...
    ' ',
    react_1.default.createElement(eui_1.EuiIconTip, { position: "right", content: react_1.default.createElement(react_2.FormattedMessage, { id: "visDefaultEditor.controls.numberInterval.minimumIntervalTooltip", defaultMessage: "Interval will be automatically scaled in the event that the provided value creates more buckets than specified by Advanced Setting's {histogramMaxBars}", values: { histogramMaxBars: 'histogram:maxBars' } }), type: "questionInCircle" })));
