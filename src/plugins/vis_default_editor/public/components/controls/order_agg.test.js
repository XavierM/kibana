...
describe('OrderAggParamEditor component', () => {
    ...
    it('defaults to the first metric agg after init', () => {
        ...
        enzyme_1.mount(react_1.default.createElement(order_by_1.OrderByParamEditor, Object.assign({}, props)));
    ...
    it('selects _key if there are no metric aggs', () => {
        enzyme_1.mount(react_1.default.createElement(order_by_1.OrderByParamEditor, Object.assign({}, defaultProps)));
        expect(setValue).toHaveBeenCalledWith('_key');
    });
});
