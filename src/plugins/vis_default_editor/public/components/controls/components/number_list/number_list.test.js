...
const number_list_1 = require("./number_list");
...
describe('NumberList', () => {
    ...
    test('should be rendered with default set of props', () => {
        const comp = enzyme_1.shallow(react_1.default.createElement(number_list_1.NumberList, Object.assign({}, defaultProps)));
    ...
    test('should show an order error', () => {
        ...
        const comp = enzyme_helpers_1.mountWithIntl(react_1.default.createElement(number_list_1.NumberList, Object.assign({}, defaultProps)));
    ...
    test('should set validity as true', () => {
        enzyme_helpers_1.mountWithIntl(react_1.default.createElement(number_list_1.NumberList, Object.assign({}, defaultProps)));
    ...
    test('should remove a number', () => {
        const comp = enzyme_1.shallow(react_1.default.createElement(number_list_1.NumberList, Object.assign({}, defaultProps)));
        const row = comp.find(number_row_1.NumberRow).first();
    ...
    test('should disable remove button if there is one number', () => {
        ...
        const comp = enzyme_1.shallow(react_1.default.createElement(number_list_1.NumberList, Object.assign({}, defaultProps)));
        expect(comp
            .find(number_row_1.NumberRow)
            .first()
            .prop('disableDelete')).toEqual(true);
    });
