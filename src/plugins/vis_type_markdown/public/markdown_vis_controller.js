 ...
 */
class MarkdownVisComponent extends react_1.default.Component {
    /**
     ...
     */
    render() {
        return (react_1.default.createElement("div", { className: "mkdVis", style: { fontSize: `${this.props.fontSize}pt` } },
            react_1.default.createElement(public_1.Markdown, { "data-test-subj": "markdownBody", markdown: this.props.markdown, openLinksInNewTab: this.props.openLinksInNewTab })));
    }
}
/**
...
function MarkdownVisWrapper(props) {
    return (react_1.default.createElement(MarkdownVisComponent, { fontSize: props.visParams.fontSize, markdown: props.visParams.markdown, openLinksInNewTab: props.visParams.openLinksInNewTab, renderComplete: props.renderComplete }));
}
