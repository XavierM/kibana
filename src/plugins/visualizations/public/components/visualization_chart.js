...
class VisualizationChart extends react_1.default.Component {
    ...
    render() {
        return (react_1.default.createElement("div", { className: "visChart__container kbn-resetFocusState", tabIndex: 0, ref: this.containerDiv },
            react_1.default.createElement("p", { className: "euiScreenReaderOnly" },
                this.props.vis.type.title,
                " visualization, not yet accessible"),
            react_1.default.createElement("div", { "aria-hidden": !this.props.vis.type.isAccessible, className: "visChart", ref: this.chartDiv })));
    }
    componentDidMount() {
