...
describe('saved_visualizations', () => {
    function testProps() {
        const savedObjects = mocks_1.coreMock.createStart().savedObjects.client;
        savedObjects.find.mockImplementation(() => ({
            total: 0,
            savedObjects: [],
        }));
        return {
    ...
    it('searches visualization title and description', async () => {
        ...
        await find_list_items_1.findListItems(props);
    ...
    it('uses type-specific toListItem function, if available', async () => {
        ...
        props.savedObjectsClient.find.mockImplementationOnce(async () => ({
            total: 2,
            savedObjects: [
                {
                    id: 'lotr',
        ...
        const items = await find_list_items_1.findListItems(props);
