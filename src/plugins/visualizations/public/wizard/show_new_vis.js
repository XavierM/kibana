 ...
 */
function showNewVisModal({ editorParams = [], onClose } = {}) {
    ...
    const element = (react_1.default.createElement(react_2.I18nProvider, null,
        react_1.default.createElement(new_vis_modal_1.NewVisModal, { isOpen: true, onClose: handleClose, editorParams: editorParams, visTypesRegistry: services_1.getTypes(), addBasePath: services_1.getHttp().basePath.prepend, uiSettings: services_1.getUISettings(), savedObjects: services_1.getSavedObjects(), usageCollection: services_1.getUsageCollector() })));
