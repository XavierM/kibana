...
describe('Persisted State Provider', () => {
    describe('state creation', () => {
        ...
        test('should create an empty state instance', () => {
            persistedState = new persisted_state_1.PersistedState();
            expect(persistedState.get()).toEqual({});
        });
        test('should create a state instance with data', () => {
            const val = { red: 'blue' };
            persistedState = new persisted_state_1.PersistedState(val);
        ...
        test('should throw if given an invalid value', () => {
            expect(() => new persisted_state_1.PersistedState('bananas')).toThrow(Error);
        });
    });
    describe('mutation', () => {
        test('should not mutate the internal object', () => {
            ...
            const persistedState = new persisted_state_1.PersistedState(persistedStateValue);
            expect({
                ...persistedState.get(),
                ...insertedObj,
    ...
    describe('JSON importing and exporting', () => {
        ...
        describe('importing state from JSON string (hydration)', () => {
            test('should set the state from JSON string input', () => {
                ...
                const persistedState = new persisted_state_1.PersistedState();
                expect(persistedState.get()).toEqual({});
    ...
    describe('get state', () => {
        test('should perform deep gets with various formats', () => {
            ...
            const persistedState = new persisted_state_1.PersistedState(obj);
    ...
    describe('set state', () => {
        describe('path format support', () => {
            ...
            test('should create deep objects with an existing path', () => {
                const persistedState = new persisted_state_1.PersistedState({}, 'deep.path');
        ...
        describe('simple replace operations', () => {
            ...
            test('should replace value with string', () => {
                persistedState = new persisted_state_1.PersistedState({ hello: 'world' });
            ...
            test('should replace value with array', () => {
                persistedState = new persisted_state_1.PersistedState({ hello: ['world', 'everyone'] });
            ...
            test('should replace value with object, removing old properties', () => {
                persistedState = new persisted_state_1.PersistedState({ hello: { message: 'world' } });
        ...
        describe('deep replace operations', () => {
            ...
            test('should change the value in the array', () => {
                persistedState = new persisted_state_1.PersistedState({ hello: { nouns: ['world', 'humans', 'everyone'] } });
    ...
    describe('internal state tracking', () => {
        ...
        test('should store the default state value', () => {
            ...
            const persistedState = new persisted_state_1.PersistedState(val);
    ...
    describe('events', () => {
        ...
        beforeEach(() => {
            persistedState = new persisted_state_1.PersistedState({ checker: { events: 'event tests' } });
