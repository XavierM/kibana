...
const tutorial_service_1 = require("./tutorial_service");
describe('TutorialService', () => {
    describe('setup', () => {
        test('allows multiple set calls', () => {
            const setup = new tutorial_service_1.TutorialService().setup();
            expect(() => {
    ...
    describe('getVariables', () => {
        test('returns empty object', () => {
            const service = new tutorial_service_1.TutorialService();
