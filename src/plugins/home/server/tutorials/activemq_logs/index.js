...
function activemqLogsSpecProvider(context) {
    ...
    return {
        id: 'activemqLogs',
        name: i18n_1.i18n.translate('home.tutorials.activemqLogs.nameTitle', {
            defaultMessage: 'ActiveMQ logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.activemqLogs.shortDescription', {
            defaultMessage: 'Collect ActiveMQ logs with Filebeat.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.activemqLogs.longDescription', {
            defaultMessage: 'Collect ActiveMQ logs with Filebeat. \
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.activemqLogs.artifacts.dashboards.linkLabel', {
