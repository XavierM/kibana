...
function kibanaMetricsSpecProvider(context) {
    ...
    return {
        id: 'kibanaMetrics',
        name: i18n_1.i18n.translate('home.tutorials.kibanaMetrics.nameTitle', {
            defaultMessage: 'Kibana metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.kibanaMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from Kibana.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.kibanaMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.kibanaMetrics.artifacts.application.label', {
