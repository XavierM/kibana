...
function natsLogsSpecProvider(context) {
    ...
    return {
        id: 'natsLogs',
        name: i18n_1.i18n.translate('home.tutorials.natsLogs.nameTitle', {
            defaultMessage: 'NATS logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        isBeta: true,
        shortDescription: i18n_1.i18n.translate('home.tutorials.natsLogs.shortDescription', {
            defaultMessage: 'Collect and parse logs created by Nats.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.natsLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.natsLogs.artifacts.dashboards.linkLabel', {
