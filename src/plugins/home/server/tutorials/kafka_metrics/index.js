...
function kafkaMetricsSpecProvider(context) {
    ...
    return {
        id: 'kafkaMetrics',
        name: i18n_1.i18n.translate('home.tutorials.kafkaMetrics.nameTitle', {
            defaultMessage: 'Kafka metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.kafkaMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from the Kafka server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.kafkaMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.kafkaMetrics.artifacts.application.label', {
