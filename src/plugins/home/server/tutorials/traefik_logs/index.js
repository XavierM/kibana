...
function traefikLogsSpecProvider(context) {
    ...
    return {
        id: 'traefikLogs',
        name: i18n_1.i18n.translate('home.tutorials.traefikLogs.nameTitle', {
            defaultMessage: 'Traefik logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.traefikLogs.shortDescription', {
            defaultMessage: 'Collect and parse access logs created by the Traefik Proxy.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.traefikLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.traefikLogs.artifacts.dashboards.linkLabel', {
