...
function cephMetricsSpecProvider(context) {
    ...
    return {
        id: 'cephMetrics',
        name: i18n_1.i18n.translate('home.tutorials.cephMetrics.nameTitle', {
            defaultMessage: 'Ceph metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.cephMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from the Ceph server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.cephMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.cephMetrics.artifacts.application.label', {
