...
function corednsMetricsSpecProvider(context) {
    ...
    return {
        id: 'corednsMetrics',
        name: i18n_1.i18n.translate('home.tutorials.corednsMetrics.nameTitle', {
            defaultMessage: 'CoreDNS metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.corednsMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from the CoreDNS server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.corednsMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.corednsMetrics.artifacts.application.label', {
