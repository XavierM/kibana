...
function iisLogsSpecProvider(context) {
    ...
    return {
        id: 'iisLogs',
        name: i18n_1.i18n.translate('home.tutorials.iisLogs.nameTitle', {
            defaultMessage: 'IIS logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.iisLogs.shortDescription', {
            defaultMessage: 'Collect and parse access and error logs created by the IIS HTTP server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.iisLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.iisLogs.artifacts.dashboards.linkLabel', {
