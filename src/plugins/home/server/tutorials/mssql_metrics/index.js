...
function mssqlMetricsSpecProvider(context) {
    ...
    return {
        id: 'mssqlMetrics',
        name: i18n_1.i18n.translate('home.tutorials.mssqlMetrics.nameTitle', {
            defaultMessage: 'Microsoft SQL Server Metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.mssqlMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from a Microsoft SQL Server instance',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.mssqlMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.mssqlMetrics.artifacts.dashboards.linkLabel', {
