...
const onprem_cloud_instructions_1 = require("../instructions/onprem_cloud_instructions");
...
function createOnPremElasticCloudInstructions() {
    ...
    return {
        instructionSets: [
            {
                title: i18n_1.i18n.translate('home.tutorials.netflow.onPremElasticCloudInstructions.title', {
