...
function vSphereMetricsSpecProvider(context) {
    ...
    return {
        id: 'vsphereMetrics',
        name: i18n_1.i18n.translate('home.tutorials.vsphereMetrics.nameTitle', {
            defaultMessage: 'vSphere metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.vsphereMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from vSphere.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.vsphereMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.vsphereMetrics.artifacts.application.label', {
