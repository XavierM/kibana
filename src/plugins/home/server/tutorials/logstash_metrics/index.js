...
function logstashMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.logstashMetrics.nameTitle', {
            defaultMessage: 'Logstash metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.logstashMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from a Logstash server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.logstashMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.logstashMetrics.artifacts.application.label', {
