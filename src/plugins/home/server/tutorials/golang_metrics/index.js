...
function golangMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.golangMetrics.nameTitle', {
            defaultMessage: 'Golang metrics',
        }),
        isBeta: true,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.golangMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from a Golang app.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.golangMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.golangMetrics.artifacts.dashboards.linkLabel', {
