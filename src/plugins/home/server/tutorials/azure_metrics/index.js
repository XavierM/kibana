...
function azureMetricsSpecProvider(context) {
    ...
    return {
        id: 'azureMetrics',
        name: i18n_1.i18n.translate('home.tutorials.azureMetrics.nameTitle', {
            defaultMessage: 'Azure metrics',
        }),
        isBeta: true,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.azureMetrics.shortDescription', {
            defaultMessage: 'Fetch Azure Monitor metrics.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.azureMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.azureMetrics.artifacts.application.label', {
