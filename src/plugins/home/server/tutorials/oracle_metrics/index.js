...
function oracleMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.oracleMetrics.nameTitle', {
            defaultMessage: 'oracle metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.oracleMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from a Oracle server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.oracleMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.oracleMetrics.artifacts.application.label', {
