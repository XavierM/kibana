...
function osqueryLogsSpecProvider(context) {
    ...
    return {
        id: 'osqueryLogs',
        name: i18n_1.i18n.translate('home.tutorials.osqueryLogs.nameTitle', {
            defaultMessage: 'Osquery logs',
        }),
        category: tutorials_1.TutorialsCategory.SIEM,
        shortDescription: i18n_1.i18n.translate('home.tutorials.osqueryLogs.shortDescription', {
            defaultMessage: 'Collect the result logs created by osqueryd.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.osqueryLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.osqueryLogs.artifacts.dashboards.linkLabel', {
