...
function memcachedMetricsSpecProvider(context) {
    ...
    return {
        id: 'memcachedMetrics',
        name: i18n_1.i18n.translate('home.tutorials.memcachedMetrics.nameTitle', {
            defaultMessage: 'Memcached metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.memcachedMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from the Memcached server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.memcachedMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.memcachedMetrics.artifacts.application.label', {
