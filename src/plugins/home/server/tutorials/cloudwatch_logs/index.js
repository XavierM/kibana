...
const functionbeat_instructions_1 = require("../instructions/functionbeat_instructions");
function cloudwatchLogsSpecProvider(context) {
    return {
        id: 'cloudwatchLogs',
        name: i18n_1.i18n.translate('home.tutorials.cloudwatchLogs.nameTitle', {
            defaultMessage: 'AWS Cloudwatch logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.cloudwatchLogs.shortDescription', {
            defaultMessage: 'Collect Cloudwatch logs with Functionbeat.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.cloudwatchLogs.longDescription', {
        ...
        onPrem: functionbeat_instructions_1.onPremInstructions([], context),
        elasticCloud: functionbeat_instructions_1.cloudInstructions(),
        onPremElasticCloud: functionbeat_instructions_1.onPremCloudInstructions(),
    };
}
