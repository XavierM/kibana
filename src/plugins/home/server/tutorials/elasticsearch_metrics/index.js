...
function elasticsearchMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.elasticsearchMetrics.nameTitle', {
            defaultMessage: 'Elasticsearch metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.elasticsearchMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from Elasticsearch.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.elasticsearchMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.elasticsearchMetrics.artifacts.application.label', {
