...
function elasticsearchLogsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.elasticsearchLogs.nameTitle', {
            defaultMessage: 'Elasticsearch logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        isBeta: true,
        shortDescription: i18n_1.i18n.translate('home.tutorials.elasticsearchLogs.shortDescription', {
            defaultMessage: 'Collect and parse logs created by Elasticsearch.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.elasticsearchLogs.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.elasticsearchLogs.artifacts.application.label', {
