...
function traefikMetricsSpecProvider(context) {
    ...
    return {
        id: 'traefikMetrics',
        name: i18n_1.i18n.translate('home.tutorials.traefikMetrics.nameTitle', {
            defaultMessage: 'Traefik metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.traefikMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from Traefik.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.traefikMetrics.longDescription', {
