...
function awsLogsSpecProvider(context) {
    ...
    return {
        id: 'awsLogs',
        name: i18n_1.i18n.translate('home.tutorials.awsLogs.nameTitle', {
            defaultMessage: 'AWS S3 based logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.awsLogs.shortDescription', {
            defaultMessage: 'Collect AWS logs from S3 bucket with Filebeat.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.awsLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.awsLogs.artifacts.dashboards.linkLabel', {
