...
function envoyproxyMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.envoyproxyMetrics.nameTitle', {
            defaultMessage: 'Envoy Proxy metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.envoyproxyMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from Envoy Proxy.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.envoyproxyMetrics.longDescription', {
