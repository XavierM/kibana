...
function logstashLogsSpecProvider(context) {
    ...
    return {
        id: 'logstashLogs',
        name: i18n_1.i18n.translate('home.tutorials.logstashLogs.nameTitle', {
            defaultMessage: 'Logstash logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.logstashLogs.shortDescription', {
            defaultMessage: 'Collect and parse debug and slow logs created by Logstash itself.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.logstashLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.logstashLogs.artifacts.dashboards.linkLabel', {
