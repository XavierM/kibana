...
function ibmmqLogsSpecProvider(context) {
    ...
    return {
        id: 'ibmmqLogs',
        name: i18n_1.i18n.translate('home.tutorials.ibmmqLogs.nameTitle', {
            defaultMessage: 'IBM MQ logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.ibmmqLogs.shortDescription', {
            defaultMessage: 'Collect IBM MQ logs with Filebeat.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.ibmmqLogs.longDescription', {
            defaultMessage: 'Collect IBM MQ logs with Filebeat. \
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.ibmmqLogs.artifacts.dashboards.linkLabel', {
