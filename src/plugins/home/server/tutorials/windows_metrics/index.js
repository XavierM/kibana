...
function windowsMetricsSpecProvider(context) {
    ...
    return {
        id: 'windowsMetrics',
        name: i18n_1.i18n.translate('home.tutorials.windowsMetrics.nameTitle', {
            defaultMessage: 'Windows metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.windowsMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from Windows.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.windowsMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.windowsMetrics.artifacts.application.label', {
