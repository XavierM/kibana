...
function postgresqlMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.postgresqlMetrics.nameTitle', {
            defaultMessage: 'PostgreSQL metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        isBeta: false,
        shortDescription: i18n_1.i18n.translate('home.tutorials.postgresqlMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from PostgreSQL.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.postgresqlMetrics.longDescription', {
