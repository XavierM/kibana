...
function mysqlLogsSpecProvider(context) {
    ...
    return {
        id: 'mysqlLogs',
        name: i18n_1.i18n.translate('home.tutorials.mysqlLogs.nameTitle', {
            defaultMessage: 'MySQL logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.mysqlLogs.shortDescription', {
            defaultMessage: 'Collect and parse error and slow logs created by MySQL.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.mysqlLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.mysqlLogs.artifacts.dashboards.linkLabel', {
