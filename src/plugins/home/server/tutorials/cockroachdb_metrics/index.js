...
function cockroachdbMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.cockroachdbMetrics.nameTitle', {
            defaultMessage: 'CockroachDB metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.cockroachdbMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from the CockroachDB server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.cockroachdbMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.cockroachdbMetrics.artifacts.dashboards.linkLabel', {
