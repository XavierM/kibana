...
function statsdMetricsSpecProvider(context) {
    ...
    return {
        id: 'statsdMetrics',
        name: i18n_1.i18n.translate('home.tutorials.statsdMetrics.nameTitle', {
            defaultMessage: 'Statsd metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.statsdMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from statsd.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.statsdMetrics.longDescription', {
