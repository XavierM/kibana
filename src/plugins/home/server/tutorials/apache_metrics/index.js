...
function apacheMetricsSpecProvider(context) {
    ...
    return {
        id: 'apacheMetrics',
        name: i18n_1.i18n.translate('home.tutorials.apacheMetrics.nameTitle', {
            defaultMessage: 'Apache metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.apacheMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from the Apache 2 HTTP server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.apacheMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.apacheMetrics.artifacts.dashboards.linkLabel', {
