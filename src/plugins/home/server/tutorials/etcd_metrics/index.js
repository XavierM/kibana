...
function etcdMetricsSpecProvider(context) {
    ...
    return {
        id: 'etcdMetrics',
        name: i18n_1.i18n.translate('home.tutorials.etcdMetrics.nameTitle', {
            defaultMessage: 'Etcd metrics',
        }),
        isBeta: false,
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.etcdMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from the Etcd server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.etcdMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.etcdMetrics.artifacts.application.label', {
