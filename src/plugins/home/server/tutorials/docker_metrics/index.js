...
function dockerMetricsSpecProvider(context) {
    ...
    return {
        id: 'dockerMetrics',
        name: i18n_1.i18n.translate('home.tutorials.dockerMetrics.nameTitle', {
            defaultMessage: 'Docker metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.dockerMetrics.shortDescription', {
            defaultMessage: 'Fetch metrics about your Docker containers.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.dockerMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.dockerMetrics.artifacts.dashboards.linkLabel', {
