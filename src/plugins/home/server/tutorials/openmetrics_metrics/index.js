...
function openmetricsMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.openmetricsMetrics.nameTitle', {
            defaultMessage: 'OpenMetrics metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.openmetricsMetrics.shortDescription', {
            defaultMessage: 'Fetch metrics from an endpoint that serves metrics in OpenMetrics format.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.openmetricsMetrics.longDescription', {
