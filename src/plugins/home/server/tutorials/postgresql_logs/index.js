...
function postgresqlLogsSpecProvider(context) {
    ...
    return {
        id: 'postgresqlLogs',
        name: i18n_1.i18n.translate('home.tutorials.postgresqlLogs.nameTitle', {
            defaultMessage: 'PostgreSQL logs',
        }),
        category: tutorials_1.TutorialsCategory.LOGGING,
        shortDescription: i18n_1.i18n.translate('home.tutorials.postgresqlLogs.shortDescription', {
            defaultMessage: 'Collect and parse error and slow logs created by PostgreSQL.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.postgresqlLogs.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.postgresqlLogs.artifacts.dashboards.linkLabel', {
