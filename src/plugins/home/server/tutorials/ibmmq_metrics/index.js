...
function ibmmqMetricsSpecProvider(context) {
    ...
    return {
        id: 'ibmmqMetrics',
        name: i18n_1.i18n.translate('home.tutorials.ibmmqMetrics.nameTitle', {
            defaultMessage: 'IBM MQ metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.ibmmqMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics from IBM MQ instances.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.ibmmqMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.ibmmqMetrics.artifacts.application.label', {
