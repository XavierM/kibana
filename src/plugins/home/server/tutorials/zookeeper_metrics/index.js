...
function zookeeperMetricsSpecProvider(context) {
    ...
    return {
        ...
        name: i18n_1.i18n.translate('home.tutorials.zookeeperMetrics.nameTitle', {
        ...
        shortDescription: i18n_1.i18n.translate('home.tutorials.zookeeperMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from a Zookeeper server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.zookeeperMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
        ...
        artifacts: {
            application: {
                label: i18n_1.i18n.translate('home.tutorials.zookeeperMetrics.artifacts.application.label', {
