...
exports.createFunctionbeatInstructions = (context) => ({
    INSTALL: {
        OSX: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.install.osxTitle', {
                defaultMessage: 'Download and install Functionbeat',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.install.osxTextPre', {
        ...
        LINUX: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.install.linuxTitle', {
                defaultMessage: 'Download and install Functionbeat',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.install.linuxTextPre', {
                defaultMessage: 'First time using Functionbeat? See the [Getting Started Guide]({link}).',
                values: { link: '{config.docs.beats.functionbeat}/functionbeat-getting-started.html' },
            }),
            commands: [
        ...
        WINDOWS: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.install.windowsTitle', {
                defaultMessage: 'Download and install Functionbeat',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.install.windowsTextPre', {
...
**Run As Administrator**). If you are running Windows XP, you might need to download and install PowerShell.\n\
 5. From the PowerShell prompt, go to the Functionbeat directory:',
    ...
    DEPLOY: {
        OSX_LINUX: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.deploy.osxTitle', {
                defaultMessage: 'Deploy Functionbeat to AWS Lambda',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.deploy.osxTextPre', {
...
Kibana index pattern. It is normally safe to omit this command.',
        ...
        WINDOWS: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.deploy.windowsTitle', {
                defaultMessage: 'Deploy Functionbeat to AWS Lambda',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.deploy.windowsTextPre', {
                defaultMessage: 'This installs Functionbeat as a Lambda function.\
The `setup` command checks the Elasticsearch configuration and loads the \
Kibana index pattern. It is normally safe to omit this command.',
            }),
    ...
    CONFIG: {
        OSX_LINUX: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.config.osxTitle', {
                defaultMessage: 'Configure the Elastic cluster',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.config.osxTextPre', {
            ...
            textPost: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.config.osxTextPost', {
...
and {kibanaUrlTemplate} is the URL of Kibana.',
        ...
        WINDOWS: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.config.windowsTitle', {
                defaultMessage: 'Edit the configuration',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.config.windowsTextPre', {
                defaultMessage: 'Modify {path} to set the connection information:',
                values: {
            ...
            textPost: i18n_1.i18n.translate('home.tutorials.common.functionbeatInstructions.config.windowsTextPost', {
                defaultMessage: 'Where {passwordTemplate} is the password of the `elastic` user, {esUrlTemplate} is the URL of Elasticsearch, \
and {kibanaUrlTemplate} is the URL of Kibana.',
                values: {
                    passwordTemplate: '`<password>`',
...
exports.createFunctionbeatCloudInstructions = () => ({
    CONFIG: {
        OSX_LINUX: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatCloudInstructions.config.osxTitle', {
                defaultMessage: 'Edit the configuration',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatCloudInstructions.config.osxTextPre', {
        ...
        WINDOWS: {
            title: i18n_1.i18n.translate('home.tutorials.common.functionbeatCloudInstructions.config.windowsTitle', {
                defaultMessage: 'Edit the configuration',
            }),
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatCloudInstructions.config.windowsTextPre', {
                defaultMessage: 'Modify {path} to set the connection information for Elastic Cloud:',
                values: {
                    path: '`C:\\Program Files\\Functionbeat\\functionbeat.yml`',
                },
...
function functionbeatEnableInstructions() {
    const defaultTitle = i18n_1.i18n.translate('home.tutorials.common.functionbeatEnableOnPremInstructions.defaultTitle', {
    ...
    const defaultTextPost = i18n_1.i18n.translate('home.tutorials.common.functionbeatEnableOnPremInstructions.defaultTextPost', {
...
Functionbeat deploy.',
    ...
    return {
        OSX_LINUX: {
            title: defaultTitle,
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatEnableOnPremInstructionsOSXLinux.textPre', {
        ...
        WINDOWS: {
            title: defaultTitle,
            textPre: i18n_1.i18n.translate('home.tutorials.common.functionbeatEnableOnPremInstructionsWindows.textPre', {
...
function functionbeatAWSInstructions() {
    const defaultTitle = i18n_1.i18n.translate('home.tutorials.common.functionbeatAWSInstructions.title', {
        defaultMessage: 'Set AWS credentials',
    });
    const defaultPre = i18n_1.i18n.translate('home.tutorials.common.functionbeatAWSInstructions.textPre', {
        defaultMessage: 'Set your AWS account credentials in the environment:',
    });
    const defaultPost = i18n_1.i18n.translate('home.tutorials.common.functionbeatAWSInstructions.textPost', {
...
function functionbeatStatusCheck() {
    return {
        title: i18n_1.i18n.translate('home.tutorials.common.functionbeatStatusCheck.title', {
            defaultMessage: 'Functionbeat status',
        }),
        text: i18n_1.i18n.translate('home.tutorials.common.functionbeatStatusCheck.text', {
            defaultMessage: 'Check that data is received from Functionbeat',
        }),
        btnLabel: i18n_1.i18n.translate('home.tutorials.common.functionbeatStatusCheck.buttonLabel', {
            defaultMessage: 'Check data',
        }),
        success: i18n_1.i18n.translate('home.tutorials.common.functionbeatStatusCheck.successText', {
            defaultMessage: 'Data successfully received from Functionbeat',
        }),
        error: i18n_1.i18n.translate('home.tutorials.common.functionbeatStatusCheck.errorText', {
...
function onPremInstructions(platforms, context) {
    const FUNCTIONBEAT_INSTRUCTIONS = exports.createFunctionbeatInstructions(context);
    return {
        instructionSets: [
            {
                title: i18n_1.i18n.translate('home.tutorials.common.functionbeat.premInstructions.gettingStarted.title', {
                ...
                instructionVariants: [
                    ...
                    {
                        id: instruction_variant_1.INSTRUCTION_VARIANT.LINUX,
                        instructions: [
...
function onPremCloudInstructions() {
    ...
    const FUNCTIONBEAT_INSTRUCTIONS = exports.createFunctionbeatInstructions();
    return {
        instructionSets: [
            {
                title: i18n_1.i18n.translate('home.tutorials.common.functionbeat.premCloudInstructions.gettingStarted.title', {
                    defaultMessage: 'Getting Started',
                }),
                instructionVariants: [
                    {
...
function cloudInstructions() {
    const FUNCTIONBEAT_INSTRUCTIONS = exports.createFunctionbeatInstructions();
    const FUNCTIONBEAT_CLOUD_INSTRUCTIONS = exports.createFunctionbeatCloudInstructions();
    return {
        instructionSets: [
            {
                title: i18n_1.i18n.translate('home.tutorials.common.functionbeat.cloudInstructions.gettingStarted.title', {
                    defaultMessage: 'Getting Started',
                }),
                instructionVariants: [
                    {
