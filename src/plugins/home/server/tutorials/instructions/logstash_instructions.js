...
exports.createLogstashInstructions = () => ({
    INSTALL: {
        OSX: [
            {
                title: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.java.osxTitle', {
                    defaultMessage: 'Download and install the Java Runtime Environment',
                }),
                textPre: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.java.osxTextPre', {
            ...
            {
                title: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.logstash.osxTitle', {
                    defaultMessage: 'Download and install Logstash',
                }),
                textPre: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.logstash.osxTextPre', {
        ...
        WINDOWS: [
            {
                title: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.java.windowsTitle', {
                    defaultMessage: 'Download and install the Java Runtime Environment',
                }),
                textPre: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.java.windowsTextPre', {
                    defaultMessage: 'Follow the installation instructions [here]({link}).',
                    values: {
            ...
            {
                title: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.logstash.windowsTitle', {
                    defaultMessage: 'Download and install Logstash',
                }),
                textPre: i18n_1.i18n.translate('home.tutorials.common.logstashInstructions.install.logstash.windowsTextPre', {
