...
function awsMetricsSpecProvider(context) {
    ...
    return {
        id: 'awsMetrics',
        name: i18n_1.i18n.translate('home.tutorials.awsMetrics.nameTitle', {
            defaultMessage: 'AWS metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.awsMetrics.shortDescription', {
            defaultMessage: 'Fetch monitoring metrics for EC2 instances from the AWS APIs and Cloudwatch.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.awsMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.awsMetrics.artifacts.dashboards.linkLabel', {
