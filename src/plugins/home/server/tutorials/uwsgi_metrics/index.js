...
function uwsgiMetricsSpecProvider(context) {
    ...
    return {
        id: 'uwsgiMetrics',
        name: i18n_1.i18n.translate('home.tutorials.uwsgiMetrics.nameTitle', {
            defaultMessage: 'uWSGI metrics',
        }),
        category: tutorials_1.TutorialsCategory.METRICS,
        shortDescription: i18n_1.i18n.translate('home.tutorials.uwsgiMetrics.shortDescription', {
            defaultMessage: 'Fetch internal metrics from the uWSGI server.',
        }),
        longDescription: i18n_1.i18n.translate('home.tutorials.uwsgiMetrics.longDescription', {
            ...
            dashboards: [
                {
                    ...
                    linkLabel: i18n_1.i18n.translate('home.tutorials.uwsgiMetrics.artifacts.dashboards.linkLabel', {
