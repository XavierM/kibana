 ...
 */
async function intializeSavedObject(savedObject, savedObjectsClient, config) {
    ...
    if (!savedObject.id) {
        ...
        lodash_1.default.assign(savedObject, savedObject.defaults);
    ...
    const respMapped = {
        _id: resp.id,
        _type: resp.type,
        _source: lodash_1.default.cloneDeep(resp.attributes),
