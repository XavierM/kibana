...
const token_iterator_1 = require("./token_iterator");
const mockTokensProviderFactory = (tokenMtx) => {
    return {
...
describe('Token Iterator', () => {
    ...
    it('iterates forwards', () => {
        const it = new token_iterator_1.TokenIterator(tokensProvider, { lineNumber: 1, column: 1 });
    ...
    it('iterates backwards', () => {
        const it = new token_iterator_1.TokenIterator(tokensProvider, { lineNumber: 1, column: 8 });
        expect(it.getCurrentToken()).toEqual({
    ...
    describe('iterating across lines', () => {
        ...
        it('iterates backwards over lines', () => {
            const it = new token_iterator_1.TokenIterator(tokensProvider, { lineNumber: 4, column: 1 });
            expect(it.getCurrentToken()).toEqual({
                position: { lineNumber: 4, column: 1 },
                type: 'whitespace',
                value: '  ',
    ...
    describe('detecting current position', () => {
        it('knows what is at the current position #1', () => {
            const it = new token_iterator_1.TokenIterator(tokensProvider, { lineNumber: 1, column: 6 });
