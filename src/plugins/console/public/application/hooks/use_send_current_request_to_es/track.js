...
exports.track = (requests, editor, trackUiMetric) => {
    ...
    const endpointDescription = get_endpoint_from_position_1.getEndpointFromPosition(coreEditor, coreEditor.getCurrentPosition(), editor.parser);
