...
const SPAN_QUERIES_NO_FIELD_MASK = {
    ...
    span_first: {
        __template: templates_1.spanFirstTemplate,
        __scope_link: '.span_first',
    },
    span_near: {
        __template: templates_1.spanNearTemplate,
        __scope_link: '.span_near',
    },
    span_or: {
        __template: templates_1.spanOrTemplate,
        __scope_link: '.span_or',
    },
    span_not: {
        __template: templates_1.spanNotTemplate,
        __scope_link: '.span_not',
    },
    span_term: {
        __template: templates_1.spanTermTemplate,
        __scope_link: '.span_term',
    },
    span_containing: {
        __template: templates_1.spanContainingTemplate,
        __scope_link: '.span_containing',
    },
    span_within: {
        __template: templates_1.spanWithinTemplate,
...
const SPAN_MULTI_QUERIES = {
    wildcard: {
        __template: templates_1.wildcardTemplate,
        __scope_link: '.wildcard',
    },
    fuzzy: {
        __template: templates_1.fuzzyTemplate,
        __scope_link: '.fuzzy',
    },
    prefix: {
        __template: templates_1.prefixTemplate,
        __scope_link: '.prefix',
    },
    range: {
        __template: templates_1.rangeTemplate,
        __scope_link: '.range',
    },
    regexp: {
        __template: templates_1.regexpTemplate,
        __scope_link: '.regexp',
    },
};
...
exports.query = (specService) => {
    specService.addGlobalAutocompleteRules('query', {
        ...
        /* jshint -W015 */
        function_score: lodash_1.default.defaults({
            __template: {
                query: {},
                functions: [{}],
            },
