...
const is_valid_es_interval_1 = require("./is_valid_es_interval");
...
function _parseWithBase(value, baseInterval) {
    try {
        const interval = least_common_interval_1.leastCommonInterval(baseInterval, value);
...
function isValidInterval(value, baseInterval) {
    if (baseInterval) {
        ...
        return is_valid_es_interval_1.isValidEsInterval(value);
    }
}
