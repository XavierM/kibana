...
const endOfInputText = i18n_1.i18n.translate('data.common.kql.errors.endOfInputText', {
    defaultMessage: 'end of input',
});
const grammarRuleTranslations = {
    fieldName: i18n_1.i18n.translate('data.common.kql.errors.fieldNameText', {
        defaultMessage: 'field name',
    }),
    value: i18n_1.i18n.translate('data.common.kql.errors.valueText', {
        defaultMessage: 'value',
    }),
    literal: i18n_1.i18n.translate('data.common.kql.errors.literalText', {
        defaultMessage: 'literal',
    }),
    whitespace: i18n_1.i18n.translate('data.common.kql.errors.whitespaceText', {
...
class KQLSyntaxError extends Error {
    constructor(error, expression) {
        ...
        if (error.expected) {
            ...
            message = i18n_1.i18n.translate('data.common.kql.errors.syntaxError', {
        ...
        const fullMessage = [message, expression, lodash_1.repeat('-', error.location.start.offset) + '^'].join('\n');
        super(fullMessage);
