...
class DateNanosFormat extends field_format_1.FieldFormat {
    constructor() {
        super(...arguments);
...
DateNanosFormat.id = types_2.FIELD_FORMAT_IDS.DATE_NANOS;
DateNanosFormat.title = i18n_1.i18n.translate('data.fieldFormats.date_nanos.title', {
    defaultMessage: 'Date nanos',
});
DateNanosFormat.fieldType = types_1.KBN_FIELD_TYPES.DATE;
