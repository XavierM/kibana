...
const relative_date_1 = require("./relative_date");
describe('Relative Date Format', () => {
    let convert;
    beforeEach(() => {
        const relativeDate = new relative_date_1.RelativeDateFormat({}, jest.fn());
    ...
    test('should parse date values', () => {
        ...
        expect(convert(val)).toBe(moment_timezone_1.default(val).fromNow());
    });
});
