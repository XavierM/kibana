...
const get_request_aborted_signal_1 = require("./get_request_aborted_signal");
describe('abortableRequestHandler', () => {
    jest.useFakeTimers();
    it('should call abort if disconnected', () => {
        const abortedSubject = new rxjs_1.Subject();
        const aborted$ = abortedSubject.asObservable();
        const onAborted = jest.fn();
        const signal = get_request_aborted_signal_1.getRequestAbortedSignal(aborted$);
