...
const defaultSearchQueryLanguageSetting = common_1.DEFAULT_QUERY_LANGUAGE;
function fetchProvider(index) {
    return async (callCluster) => {
        ...
        const queryLanguageConfigValue = lodash_1.get(config, 'hits.hits[0]._source.config.search:queryLanguage');
        ...
        const kqlTelemetryDoc = {
            optInCount: 0,
            optOutCount: 0,
            ...lodash_1.get(response, '_source.kql-telemetry', {}),
        };
        return {
            ...kqlTelemetryDoc,
