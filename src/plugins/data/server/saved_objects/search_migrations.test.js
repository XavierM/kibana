...
const search_migrations_1 = require("./search_migrations");
const savedObjectMigrationContext = null;
describe('migration search', () => {
    describe('6.7.2', () => {
        const migrationFn = search_migrations_1.searchSavedObjectTypeMigrations['6.7.2'];
    ...
    describe('7.0.0', () => {
        const migrationFn = search_migrations_1.searchSavedObjectTypeMigrations['7.0.0'];
...
`);
    ...
    describe('7.4.0', function () {
        const migrationFn = search_migrations_1.searchSavedObjectTypeMigrations['7.4.0'];
