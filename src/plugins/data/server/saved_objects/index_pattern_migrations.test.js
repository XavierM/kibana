...
const index_pattern_migrations_1 = require("./index_pattern_migrations");
const savedObjectMigrationContext = null;
describe('migration index-pattern', () => {
    describe('6.5.0', () => {
        const migrationFn = index_pattern_migrations_1.indexPatternSavedObjectTypeMigrations['6.5.0'];
        test('adds "type" and "typeMeta" properties to object when not declared', () => {
            expect(migrationFn({
                type: 'index-pattern',
                attributes: {},
            }, savedObjectMigrationContext)).toMatchInlineSnapshot(`
Object {
  "attributes": Object {
    "type": undefined,
    "typeMeta": undefined,
...
`);
    ...
    describe('7.6.0', () => {
        const migrationFn = index_pattern_migrations_1.indexPatternSavedObjectTypeMigrations['7.6.0'];
