...
exports.indexPatternSavedObjectTypeMigrations = {
    '6.5.0': lodash_1.flow(migrateAttributeTypeAndAttributeTypeMeta),
    '7.6.0': lodash_1.flow(migrateSubTypeAndParentFieldProperties),
};
