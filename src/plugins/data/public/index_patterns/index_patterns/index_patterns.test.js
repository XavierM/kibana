...
jest.mock('./index_patterns_api_client', () => {
    class IndexPatternsApiClient {
        constructor() {
            this.getFieldsForWildcard = async () => ({});
        }
    }
    return {
...
describe('IndexPatterns', () => {
    ...
    beforeEach(() => {
        savedObjectsClient = {};
        savedObjectsClient.find = jest.fn(() => Promise.resolve({
            savedObjects: [{ id: 'id', attributes: { title: 'title' } }],
        }));
        const core = {};
        const http = {};
        indexPatterns = new index_patterns_1.IndexPatternsService(core, savedObjectsClient, http);
    });
