...
const index_patterns_api_client_test_mock_1 = require("./index_patterns_api_client.test.mock");
...
describe('IndexPatternsApiClient', () => {
    ...
    beforeEach(() => {
        fetchSpy = jest.spyOn(index_patterns_api_client_test_mock_1.http, 'fetch').mockImplementation(() => Promise.resolve({}));
        indexPatternsApiClient = new index_patterns_api_client_1.IndexPatternsApiClient(index_patterns_api_client_test_mock_1.http);
    });
