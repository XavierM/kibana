...
const defaultOnQuerySubmit = (props, queryService, currentQuery, setQueryStringState) => {
    ...
    const { timefilter } = queryService.timefilter;
    return (payload) => {
        const isUpdate = !_.isEqual(timefilter.getTime(), payload.dateRange) ||
