...
exports.useTimefilter = (props) => {
    ...
    const [timeRange, setTimerange] = react_1.useState(initialTimeRange);
    const [refreshInterval, setRefreshInterval] = react_1.useState(initialRefreshInterval);
    react_1.useEffect(() => {
