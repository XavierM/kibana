...
describe('ShardFailureDescription', () => {
    it('renders matching snapshot given valid properties', () => {
        const failure = shard_failure_response_1.shardFailureResponse._shards.failures[0];
        const component = enzyme_helpers_1.shallowWithIntl(react_1.default.createElement(shard_failure_description_1.ShardFailureDescription, Object.assign({}, failure)));
