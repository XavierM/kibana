...
describe('ShardFailureTable', () => {
    it('renders matching snapshot given valid properties', () => {
        const failures = shard_failure_response_1.shardFailureResponse._shards.failures;
        const component = enzyme_helpers_1.shallowWithIntl(react_1.default.createElement(shard_failure_table_1.ShardFailureTable, { failures: failures }));
