...
function FilterBarUI(props) {
    ...
    function renderItems() {
        return props.filters.map((filter, i) => (react_2.default.createElement(eui_1.EuiFlexItem, { key: i, grow: false, className: "globalFilterBar__flexItem" },
            react_2.default.createElement(filter_item_1.FilterItem, { id: `${i}`, filter: filter, onUpdate: newFilter => onUpdate(i, newFilter), onRemove: () => onRemove(i), indexPatterns: props.indexPatterns, uiSettings: uiSettings }))));
    }
    function renderAddFilter() {
        ...
        return (react_2.default.createElement(eui_1.EuiFlexItem, { grow: false },
            react_2.default.createElement(eui_1.EuiPopover, { id: "addFilterPopover", button: button, isOpen: isAddFilterPopoverOpen, closePopover: () => setIsAddFilterPopoverOpen(false), anchorPosition: "downLeft", withTitle: true, panelPaddingSize: "none", ownFocus: true, initialFocus: ".filterEditor__hiddenItem" },
