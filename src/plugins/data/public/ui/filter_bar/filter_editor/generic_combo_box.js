...
function GenericComboBox(props) {
    ...
    return (react_1.default.createElement(eui_1.EuiComboBox, Object.assign({ options: euiOptions, selectedOptions: selectedEuiOptions, onChange: onComboBoxChange }, otherProps)));
}
