...
function SavedQueryManagementComponent({ showSaveQuery, loadedSavedQuery, onSave, onSaveAsNew, onLoad, onClearSavedQuery, savedQueryService, }) {
    ...
    const savedQueryPopoverButton = (react_1.default.createElement(eui_1.EuiButtonEmpty, { onClick: () => {
            setIsOpen(!isOpen);
        }, "aria-label": i18n_1.i18n.translate('data.search.searchBar.savedQueryPopoverButtonText', {
    ...
    const savedQueryRows = () => {
        ...
        return savedQueriesReordered.map(savedQuery => (react_1.default.createElement(saved_query_list_item_1.SavedQueryListItem, { key: savedQuery.id, savedQuery: savedQuery, isSelected: !!loadedSavedQuery && loadedSavedQuery.id === savedQuery.id, onSelect: savedQueryToSelect => {
                onLoad(savedQueryToSelect);
                setIsOpen(false);
            }, onDelete: savedQueryToDelete => onDeleteSavedQuery(savedQueryToDelete), showWriteOperations: !!showSaveQuery })));
    };
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(eui_1.EuiPopover, { id: "savedQueryPopover", button: savedQueryPopoverButton, isOpen: isOpen, closePopover: () => {
                setIsOpen(false);
            }, anchorPosition: "downLeft", panelPaddingSize: "none", ownFocus: true },
                    ...
                    react_1.default.createElement(eui_1.EuiFlexGroup, { direction: "rowReverse", gutterSize: "s", alignItems: "center", justifyContent: "flexEnd", responsive: false, wrap: true },
                        showSaveQuery && loadedSavedQuery && (react_1.default.createElement(react_1.Fragment, null,
                            react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
                                react_1.default.createElement(eui_1.EuiButton, { size: "s", fill: true, onClick: () => onSave(), "aria-label": i18n_1.i18n.translate('data.search.searchBar.savedQueryPopoverSaveChangesButtonAriaLabel', {
                            ...
                            react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
                                react_1.default.createElement(eui_1.EuiButton, { size: "s", onClick: () => onSaveAsNew(), "aria-label": i18n_1.i18n.translate('data.search.searchBar.savedQueryPopoverSaveAsNewButtonAriaLabel', {
                        ...
                        showSaveQuery && !loadedSavedQuery && (react_1.default.createElement(eui_1.EuiFlexItem, { grow: false },
                            react_1.default.createElement(eui_1.EuiButton, { size: "s", fill: true, onClick: () => onSave(), "aria-label": i18n_1.i18n.translate('data.search.searchBar.savedQueryPopoverSaveButtonAriaLabel', { defaultMessage: 'Save a new saved query' }), "data-test-subj": "saved-query-management-save-button" }, i18n_1.i18n.translate('data.search.searchBar.savedQueryPopoverSaveButtonText', {
