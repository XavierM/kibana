...
function QueryLanguageSwitcher(props) {
    ...
    const button = (react_2.default.createElement(eui_1.EuiButtonEmpty, { size: "xs", onClick: () => setIsPopoverOpen(!isPopoverOpen), className: "euiFormControlLayout__append", "data-test-subj": 'switchQueryLanguageButton' }, props.language === 'lucene' ? luceneLabel : kqlLabel));
    return (react_2.default.createElement(eui_1.EuiPopover, { id: "queryLanguageSwitcherPopover", anchorClassName: "euiFormControlLayout__append", ownFocus: true, anchorPosition: props.anchorPosition || 'downRight', button: button, isOpen: isPopoverOpen, closePopover: () => setIsPopoverOpen(false), withTitle: true },
