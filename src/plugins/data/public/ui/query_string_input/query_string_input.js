...
class QueryStringInputUI extends react_1.Component {
    ...
    render() {
        ...
        return (react_2.default.createElement(eui_1.EuiOutsideClickDetector, { onOutsideClick: this.onOutsideClick },
            react_2.default.createElement("div", Object.assign({}, ariaCombobox, { style: { position: 'relative' }, "aria-label": i18n_1.i18n.translate('data.query.queryBar.comboboxAriaLabel', {
                ...
                react_2.default.createElement("div", { role: "search" },
                    react_2.default.createElement("div", { className: "kuiLocalSearchAssistedInput" },
                        react_2.default.createElement(eui_1.EuiFieldText, { placeholder: this.props.placeholder ||
                                i18n_1.i18n.translate('data.query.queryBar.searchInputPlaceholder', {
                                    defaultMessage: 'Search',
                                }), value: this.getQueryString(), onKeyDown: this.onKeyDown, onKeyUp: this.onKeyUp, onChange: this.onInputChange, onClick: this.onClickInput, fullWidth: true, autoFocus: !this.props.disableAutoFocus, inputRef: node => {
                                if (node) {
                                    this.inputRef = node;
                                }
                                ...
                                values: { pageType: this.services.appName },
                            }), type: "text", "aria-autocomplete": "list", "aria-controls": this.state.isSuggestionsVisible ? 'kbnTypeahead__items' : undefined, "aria-activedescendant": this.state.isSuggestionsVisible && typeof this.state.index === 'number'
                                ? `suggestion-${this.state.index}`
                                : undefined, role: "textbox", prepend: this.props.prepend, append: react_2.default.createElement(language_switcher_1.QueryLanguageSwitcher, { language: this.props.query.language, anchorPosition: this.props.languageSwitcherPopoverAnchorPosition, onSelectLanguage: this.onSelectLanguage }), "data-test-subj": this.props.dataTestSubj || 'queryInput' }))),
