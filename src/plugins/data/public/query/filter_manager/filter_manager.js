...
class FilterManager {
    ...
    /* Setters */
    addFilters(filters, pinFilterStatus = this.uiSettings.get('filters:pinnedByDefault')) {
    ...
    setFilters(newFilters, pinFilterStatus = this.uiSettings.get('filters:pinnedByDefault')) {
        const store = pinFilterStatus ? common_1.FilterStateStore.GLOBAL_STATE : common_1.FilterStateStore.APP_STATE;
