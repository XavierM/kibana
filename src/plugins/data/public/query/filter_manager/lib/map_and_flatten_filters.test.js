...
const map_and_flatten_filters_1 = require("./map_and_flatten_filters");
describe('filter manager utilities', () => {
    describe('mapAndFlattenFilters()', () => {
        let filters;
        function getDisplayName(filter) {
        ...
        test('should map and flatten the filters', () => {
            const results = map_and_flatten_filters_1.mapAndFlattenFilters(filters);
