...
const map_geo_bounding_box_1 = require("./map_geo_bounding_box");
describe('filter manager utilities', () => {
    describe('mapGeoBoundingBox()', () => {
        test('should return the key and value for matching filters with bounds', async () => {
            ...
            const result = map_geo_bounding_box_1.mapGeoBoundingBox(filter);
            ...
            if (result.value) {
                ...
                expect(displayName.replace(/&[a-z]+?;/g, '').replace(/[^a-z0-9]/g, '')).toBe('lat5lon10tolat15lon20');
            }
        });
        ...
        test('should return undefined for none matching', async (done) => {
            ...
            try {
                map_geo_bounding_box_1.mapGeoBoundingBox(filter);
            }
            catch (e) {
