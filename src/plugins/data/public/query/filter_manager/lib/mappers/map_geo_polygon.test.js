...
const map_geo_polygon_1 = require("./map_geo_polygon");
describe('filter manager utilities', () => {
    ...
    describe('mapGeoPolygon()', () => {
        test('should return the key and value for matching filters with bounds', async () => {
            const result = map_geo_polygon_1.mapGeoPolygon(filter);
            ...
            if (result.value) {
                ...
                expect(displayName.replace(/&[a-z]+?;/g, '').replace(/[^a-z0-9]/g, '')).toBe('lat5lon10lat15lon20');
            }
        });
        ...
        test('should return undefined for none matching', async (done) => {
            ...
            try {
                map_geo_polygon_1.mapGeoPolygon(wrongFilter);
            }
            catch (e) {
