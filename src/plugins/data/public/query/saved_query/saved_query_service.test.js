...
const saved_query_service_1 = require("./saved_query_service");
...
const savedQueryAttributesWithFilters = {
...
const { deleteSavedQuery, getSavedQuery, findSavedQueries, saveQuery, getAllSavedQueries, getSavedQueryCount, } = saved_query_service_1.createSavedQueryService(
// @ts-ignore
...
describe('saved query service', () => {
    ...
    describe('saveQuery', function () {
        ...
        it('should optionally accept filters and timefilters in object format', async () => {
            ...
            expect(mockSavedObjectsClient.create).toHaveBeenCalledWith('query', serializedSavedQueryAttributesWithFilters, { id: 'foo' });
    ...
    describe('findSavedQueries', function () {
        ...
        it('should return an array of saved queries', async () => {
            ...
            const response = await findSavedQueries();
            expect(response.queries).toEqual(expect.objectContaining([
                {
                    attributes: {
                        description: 'bar',
