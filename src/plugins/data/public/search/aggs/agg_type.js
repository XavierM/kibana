...
class AggType {
    ...
    constructor(config, { getInternalStartServices }) {
        ...
        if (config.params && config.params.length && config.params[0] instanceof base_1.BaseParamType) {
            ...
            this.params = agg_params_1.initParams(params, { getInternalStartServices });
        }
        ...
        this.getFormat =
            config.getFormat ||
                ((agg) => {
                    ...
                    return field ? field.format : fieldFormats.getDefaultInstance(common_1.KBN_FIELD_TYPES.STRING);
                });
