...
const overallMinLabel = i18n_1.i18n.translate('data.search.aggs.metrics.overallMinLabel', {
    defaultMessage: 'overall min',
});
const minBucketTitle = i18n_1.i18n.translate('data.search.aggs.metrics.minBucketTitle', {
    defaultMessage: 'Min Bucket',
});
exports.getBucketMinMetricAgg = ({ getInternalStartServices, }) => {
    return new metric_agg_type_1.MetricAggType({
        name: metric_agg_types_1.METRIC_TYPES.MIN_BUCKET,
        title: minBucketTitle,
        makeLabel: agg => make_nested_label_1.makeNestedLabel(agg, overallMinLabel),
