...
const overallSumLabel = i18n_1.i18n.translate('data.search.aggs.metrics.overallSumLabel', {
    defaultMessage: 'overall sum',
});
const sumBucketTitle = i18n_1.i18n.translate('data.search.aggs.metrics.sumBucketTitle', {
    defaultMessage: 'Sum Bucket',
});
exports.getBucketSumMetricAgg = ({ getInternalStartServices, }) => {
    return new metric_agg_type_1.MetricAggType({
        name: metric_agg_types_1.METRIC_TYPES.SUM_BUCKET,
        title: sumBucketTitle,
        makeLabel: agg => make_nested_label_1.makeNestedLabel(agg, overallSumLabel),
