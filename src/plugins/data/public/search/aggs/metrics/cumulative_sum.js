...
exports.getCumulativeSumMetricAgg = ({ getInternalStartServices, }) => {
    return new metric_agg_type_1.MetricAggType({
        name: metric_agg_types_1.METRIC_TYPES.CUMULATIVE_SUM,
        title: cumulativeSumTitle,
        subtype: parent_pipeline_agg_helper_1.parentPipelineAggHelper.subtype,
        makeLabel: agg => make_nested_label_1.makeNestedLabel(agg, cumulativeSumLabel),
        params: [...parent_pipeline_agg_helper_1.parentPipelineAggHelper.params()],
        getFormat: parent_pipeline_agg_helper_1.parentPipelineAggHelper.getFormat,
    }, {
