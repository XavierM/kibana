...
const ip_range_1 = require("../ip_range");
const ip_range_2 = require("./ip_range");
    ...
    describe('IP range', () => {
        ...
        test('should return a range filter for ip_range agg', () => {
            const aggConfigs = getAggConfigs([
                {
                    type: bucket_agg_types_1.BUCKET_TYPES.IP_RANGE,
                    schema: 'segment',
                    params: {
                        field: 'ip',
                        ipRangeType: 'range',
            ...
            const filter = ip_range_2.createFilterIpRange(aggConfigs.aggs[0], {
                type: 'range',
                from: '0.0.0.0',
                to: '1.1.1.1',
            });
