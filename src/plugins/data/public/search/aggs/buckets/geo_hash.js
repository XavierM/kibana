...
const geohashGridTitle = i18n_1.i18n.translate('data.search.aggs.buckets.geohashGridTitle', {
    defaultMessage: 'Geohash',
});
exports.getGeoHashBucketAgg = ({ getInternalStartServices }) => new bucket_agg_type_1.BucketAggType({
    name: bucket_agg_types_1.BUCKET_TYPES.GEOHASH_GRID,
