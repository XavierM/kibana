...
exports.getFiltersBucketAgg = ({ uiSettings, getInternalStartServices, }) => new bucket_agg_type_1.BucketAggType({
    ...
    params: [
        {
            ...
            write(aggConfig, output) {
                ...
                inFilters.forEach(filter => {
                    const persistedLog = query_1.getQueryLog(uiSettings, new public_1.Storage(window.localStorage), 'vis_default_editor', filter.input.language);
