...
describe('Histogram Agg', () => {
    ...
    const getAggConfigs = (params) => {
        ...
        return new agg_configs_1.AggConfigs(indexPattern, [
            ...
            typesRegistry: test_helpers_1.mockAggTypesRegistry([histogram_1.getHistogramBucketAgg(aggTypesDependencies)]),
    ...
    const getParams = (options) => {
        ...
        return aggConfigs.aggs[0].toDsl()[bucket_agg_types_1.BUCKET_TYPES.HISTOGRAM];
    };
    describe('ordered', () => {
        let histogramType;
        beforeEach(() => {
            histogramType = histogram_1.getHistogramBucketAgg(aggTypesDependencies);
        });
        test('is ordered', () => {
    ...
    describe('params', () => {
        describe('intervalBase', () => {
            test('should not be written to the DSL', () => {
                ...
                const { [bucket_agg_types_1.BUCKET_TYPES.HISTOGRAM]: params } = aggConfigs.aggs[0].toDsl();
        ...
        describe('interval', () => {
            ...
            describe('interval scaling', () => {
                const getInterval = (maxBars, params, autoBounds) => {
                    aggTypesDependencies = {
                        ...aggTypesDependencies,
                        uiSettings: {
                ...
                test('will respect the histogram:maxBars setting', () => {
                    const params = getInterval(5, { interval: 5 }, {
                        min: 0,
                        max: 10000,
                    });
