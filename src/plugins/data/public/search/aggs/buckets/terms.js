...
exports.getTermsBucketAgg = ({ getInternalStartServices }) => new bucket_agg_type_1.BucketAggType({
    ...
    postFlightRequest: async (resp, aggConfigs, aggConfig, searchSource, inspectorAdapters, abortSignal) => {
        ...
        if (aggConfig.params.otherBucket) {
            ...
            const request = inspectorAdapters.requests.start(i18n_1.i18n.translate('data.search.aggs.buckets.terms.otherBucketTitle', {
