...
class CidrMask {
    constructor(mask) {
        ...
        this.initialAddress = new public_1.Ipv4Address(splits[0]);
    ...
    getRange() {
        ...
        return {
            from: new public_1.Ipv4Address(fromAddress).toString(),
            to: new public_1.Ipv4Address(fromAddress + numAddresses - 1).toString(),
        };
    }
    toString() {
