...
const time_buckets_1 = require("./time_buckets");
describe('TimeBuckets', () => {
    ...
    test('setBounds/getBounds - bounds is correct', () => {
        const timeBuckets = new time_buckets_1.TimeBuckets(timeBucketConfig);
        const bounds = {
            min: moment_1.default('2020-03-25'),
            max: moment_1.default('2020-03-31'),
        };
