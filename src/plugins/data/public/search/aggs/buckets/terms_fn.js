...
exports.aggTerms = () => ({
    name: fnName,
    help: i18n_1.i18n.translate('data.search.aggs.function.buckets.terms.help', {
    ...
    args: {
        id: {
            types: ['string'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.id.help', {
        ...
        enabled: {
            types: ['boolean'],
            default: true,
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.enabled.help', {
                defaultMessage: 'Specifies whether this aggregation should be enabled',
            }),
        },
        schema: {
            types: ['string'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.schema.help', {
        ...
        field: {
            types: ['string'],
            required: true,
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.field.help', {
        ...
        order: {
            types: ['string'],
            required: true,
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.order.help', {
                defaultMessage: 'Order in which to return the results: asc or desc',
            }),
        },
        orderBy: {
            types: ['string'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.orderBy.help', {
                defaultMessage: 'Field to order results by',
            }),
        },
        orderAgg: {
            types: ['agg_type'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.orderAgg.help', {
        ...
        size: {
            types: ['number'],
            default: 5,
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.size.help', {
        ...
        missingBucket: {
            types: ['boolean'],
            default: false,
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.missingBucket.help', {
      ...
      Visible when you create a chart with a terms aggregation and enable "Show missing values"`,
            ...
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.missingBucketLabel.help', {
        ...
        otherBucket: {
            types: ['boolean'],
            default: false,
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.otherBucket.help', {
        ...
        otherBucketLabel: {
            ...
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.otherBucketLabel.help', {
                defaultMessage: 'Default label used in charts for documents in the Other bucket',
            }),
        },
        exclude: {
            types: ['string'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.exclude.help', {
                defaultMessage: 'Specific bucket values to exclude from results',
            }),
        },
        include: {
            types: ['string'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.include.help', {
                defaultMessage: 'Specific bucket values to include in results',
            }),
        },
        json: {
            types: ['string'],
            help: i18n_1.i18n.translate('data.search.aggs.buckets.terms.json.help', {
