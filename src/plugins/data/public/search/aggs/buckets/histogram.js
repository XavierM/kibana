...
exports.getHistogramBucketAgg = ({ uiSettings, getInternalStartServices, }) => new bucket_agg_type_1.BucketAggType({
    ...
    createFilter: histogram_1.createFilterHistogram,
    decorateAggConfig() {
        let autoBounds;
        return {
            setAutoBounds: {
            ...
            modifyAggConfigOnSearchRequestStart(aggConfig, searchSource, options) {
                ...
                return childSearchSource
                    ...
                    if (e.name === 'AbortError')
                        return;
                    getInternalStartServices().notifications.toasts.addWarning(i18n_1.i18n.translate('data.search.aggs.histogram.missingMaxMinValuesWarning', {
