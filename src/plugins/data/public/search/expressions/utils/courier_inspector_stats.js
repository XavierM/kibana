...
function getRequestInspectorStats(searchSource) {
    ...
    if (index) {
        stats.indexPattern = {
            label: i18n_1.i18n.translate('data.search.searchSource.indexPatternLabel', {
                defaultMessage: 'Index pattern',
            }),
            value: index.title,
            description: i18n_1.i18n.translate('data.search.searchSource.indexPatternDescription', {
                defaultMessage: 'The index pattern that connected to the Elasticsearch indices.',
            }),
        };
        stats.indexPatternId = {
            label: i18n_1.i18n.translate('data.search.searchSource.indexPatternIdLabel', {
                defaultMessage: 'Index pattern ID',
            }),
            value: index.id,
            description: i18n_1.i18n.translate('data.search.searchSource.indexPatternIdDescription', {
...
function getResponseInspectorStats(searchSource, resp) {
    ...
    if (resp && resp.took) {
        stats.queryTime = {
            label: i18n_1.i18n.translate('data.search.searchSource.queryTimeLabel', {
                defaultMessage: 'Query time',
            }),
            value: i18n_1.i18n.translate('data.search.searchSource.queryTimeValue', {
                defaultMessage: '{queryTime}ms',
                values: { queryTime: resp.took },
            }),
            description: i18n_1.i18n.translate('data.search.searchSource.queryTimeDescription', {
    ...
    if (resp && resp.hits) {
        stats.hitsTotal = {
            label: i18n_1.i18n.translate('data.search.searchSource.hitsTotalLabel', {
                defaultMessage: 'Hits (total)',
            }),
            value: `${resp.hits.total}`,
            description: i18n_1.i18n.translate('data.search.searchSource.hitsTotalDescription', {
                defaultMessage: 'The number of documents that match the query.',
            }),
        };
        stats.hits = {
            label: i18n_1.i18n.translate('data.search.searchSource.hitsLabel', {
                defaultMessage: 'Hits',
            }),
            value: `${resp.hits.hits.length}`,
            description: i18n_1.i18n.translate('data.search.searchSource.hitsDescription', {
    ...
    if (lastRequest && (lastRequest.ms === 0 || lastRequest.ms)) {
        stats.requestTime = {
            label: i18n_1.i18n.translate('data.search.searchSource.requestTimeLabel', {
                defaultMessage: 'Request time',
            }),
            value: i18n_1.i18n.translate('data.search.searchSource.requestTimeValue', {
                defaultMessage: '{requestTime}ms',
                values: { requestTime: lastRequest.ms },
            }),
            description: i18n_1.i18n.translate('data.search.searchSource.requestTimeDescription', {
