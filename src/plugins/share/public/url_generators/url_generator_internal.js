...
class UrlGeneratorInternal {
    constructor(spec, getGenerator) {
        this.spec = spec;
        this.getGenerator = getGenerator;
        if (spec.isDeprecated && !spec.migrate) {
            throw new Error(i18n_1.i18n.translate('share.urlGenerators.error.noMigrationFnProvided', {
                defaultMessage: 'If the access link generator is marked as deprecated, you must provide a migration function.',
            }));
        }
        if (!spec.isDeprecated && spec.migrate) {
            throw new Error(i18n_1.i18n.translate('share.urlGenerators.error.migrationFnGivenNotDeprecated', {
        ...
        if (!spec.createUrl && !spec.isDeprecated) {
            throw new Error(i18n_1.i18n.translate('share.urlGenerators.error.noCreateUrlFnProvided', {
                defaultMessage: 'This generator is not marked as deprecated. Please provide a createUrl fn.',
            }));
        }
        if (spec.createUrl && spec.isDeprecated) {
            throw new Error(i18n_1.i18n.translate('share.urlGenerators.error.createUrlFnProvided', {
        ...
        return {
            ...
            migrate: async (state) => {
                if (!this.spec.isDeprecated) {
                    throw new Error(i18n_1.i18n.translate('share.urlGenerators.error.migrateCalledNotDeprecated', {
