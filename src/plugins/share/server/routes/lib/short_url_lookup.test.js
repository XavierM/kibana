...
const short_url_lookup_1 = require("./short_url_lookup");
...
describe('shortUrlLookupProvider', () => {
    ...
    let shortUrl;
    beforeEach(() => {
        savedObjects = mocks_1.savedObjectsClientMock.create();
        savedObjects.create.mockResolvedValue({ id: ID });
        deps = { savedObjects };
        shortUrl = short_url_lookup_1.shortUrlLookupProvider({ logger: mocks_1.loggingServiceMock.create().get() });
    });
