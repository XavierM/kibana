...
const indexed_array_1 = require("../../../../../legacy/ui/public/indexed_array");
const management_sidebar_nav_1 = require("./management_sidebar_nav");
const toIndexedArray = (initialSet) => new indexed_array_1.IndexedArray({
    index: ['id'],
    order: ['order'],
    initialSet,
});
...
describe('Management', () => {
    it('maps legacy sections and apps into SidebarNav items', () => {
        expect(management_sidebar_nav_1.mergeLegacyItems([], managementSections, 'active-item-id')).toMatchSnapshot();
    });
    it('adds legacy apps to existing SidebarNav sections', () => {
        ...
        expect(management_sidebar_nav_1.mergeLegacyItems([navSection], managementSections, 'active-item-id')).toMatchSnapshot();
    });
});
