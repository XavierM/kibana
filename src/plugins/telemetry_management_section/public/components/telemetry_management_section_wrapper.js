...
function telemetryManagementSectionWrapper(telemetryService) {
    const TelemetryManagementSectionWrapper = (props) => (react_1.default.createElement(telemetry_management_section_1.TelemetryManagementSection, Object.assign({ showAppliesSettingMessage: true, telemetryService: telemetryService }, props)));
