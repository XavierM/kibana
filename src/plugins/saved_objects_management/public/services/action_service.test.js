...
const action_service_1 = require("./action_service");
const types_1 = require("./types");
class DummyAction extends types_1.SavedObjectsManagementAction {
    constructor(id) {
        super();
        this.id = id;
        this.euiAction = {
...
describe('SavedObjectsManagementActionRegistry', () => {
    ...
    beforeEach(() => {
        service = new action_service_1.SavedObjectsManagementActionService();
        setup = service.setup();
    });
    describe('#register', () => {
        ...
        it('does not allow actions with duplicate ids to be registered', () => {
            ...
            setup.register(action);
            expect(() => setup.register(action)).toThrowErrorMatchingInlineSnapshot(`"Saved Objects Management Action with id 'my-action' already exists"`);
        });
    });
    describe('#has', () => {
