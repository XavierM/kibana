...
describe('Intro component', () => {
    const mountHeader = (props) => enzyme_1.mount(react_1.default.createElement(react_2.I18nProvider, null,
        react_1.default.createElement(header_1.Header, Object.assign({}, props)))).find('Header');
    const defaultProps = {
        type: 'search',
        canEdit: true,
        canDelete: true,
