...
describe('extractExportDetails', () => {
    ...
    it('should extract the export details from the export blob', async () => {
        ...
        const result = await extract_export_details_1.extractExportDetails(exportData);
