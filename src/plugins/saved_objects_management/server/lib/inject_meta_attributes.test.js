...
describe('injectMetaAttributes', () => {
    ...
    it('inject the metadata to the obj', () => {
        ...
        const objWithMeta = inject_meta_attributes_1.injectMetaAttributes(obj, managementService);
    ...
    it('does not alter the original object', () => {
        ...
        inject_meta_attributes_1.injectMetaAttributes(obj, managementService);
