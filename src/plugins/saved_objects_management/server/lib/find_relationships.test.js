...
const find_relationships_1 = require("./find_relationships");
const management_mock_1 = require("../services/management.mock");
...
describe('findRelationships', () => {
    ...
    beforeEach(() => {
        ...
        managementService = management_mock_1.managementMock.create();
    });
    it('returns the child and parent references of the object', async () => {
        ...
        const relationships = await find_relationships_1.findRelationships({
            type,
            id,
            size: 20,
        ...
        expect(savedObjectsClient.bulkGet).toHaveBeenCalledWith(references.map(ref => ({
            id: ref.id,
            type: ref.type,
        })));
