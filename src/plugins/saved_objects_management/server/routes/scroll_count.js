...
exports.registerScrollForCountRoute = (router) => {
    router.post({
        ...
        validate: {
            body: config_schema_1.schema.object({
                ...
                searchString: config_schema_1.schema.maybe(config_schema_1.schema.string()),
            }),
        },
        ...
        const objects = await lib_1.findAll(client, findOptions);
