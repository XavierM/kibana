...
const contextMock = mocks_1.savedObjectsServiceMock.createMigrationContext();
describe('dashboard', () => {
    describe('7.0.0', () => {
        const migration = dashboard_migrations_1.dashboardSavedObjectTypeMigrations['7.0.0'];
        test('skips error on empty object', () => {
            expect(migration({}, contextMock)).toMatchInlineSnapshot(`
Object {
  "references": Array [],
}
`);
