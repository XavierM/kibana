...
const dashboard_migrations_1 = require("./dashboard_migrations");
const migrations_730_1 = require("./migrations_730");
const mockContext = mocks_1.savedObjectsServiceMock.createMigrationContext();
    ...
    const doc = {
        ...
        attributes: {
            ...
            kibanaSavedObjectMeta: {
                searchSourceJSON: '{"filter":[{"query":{"query_string":{"query":"n: 6","analyze_wildcard":true}}}],"highlightAll":true,"version":true}',
            },
            panelsJSON: '[{"id":"1","type":"visualization","foo":true},{"id":"2","type":"visualization","bar":true}]',
        },
    };
    const newDoc = migrations_730_1.migrations730(doc, mockContext);
...
test('dashboard migration 7.3.0 migrates filters to query on search source when there is no query string property', () => {
    ...
    const doc700 = dashboard_migrations_1.dashboardSavedObjectTypeMigrations['7.0.0'](doc, mockContext);
    const newDoc = dashboard_migrations_1.dashboardSavedObjectTypeMigrations['7.3.0'](doc700, mockContext);
...
test('dashboard migration 7.3.0 migrates panels', () => {
    const doc = {
        ...
        attributes: {
            ...
            panelsJSON: '[{"size_x":6,"size_y":3,"panelIndex":1,"type":"visualization","id":"AWtIUP8QRNXhJVz2_Mar","col":1,"row":1}]',
        },
    };
    const newDoc = migrations_730_1.migrations730(doc, mockContext);
