...
test('getDashboardIdFromUrl', () => {
    let url = "http://localhost:5601/wev/app/kibana#/dashboard?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-15m,to:now))&_a=(description:'',filters:!()";
    expect(url_1.getDashboardIdFromUrl(url)).toEqual(undefined);
    url =
    ...
    expect(url_1.getDashboardIdFromUrl(url)).toEqual('625357282');
    url = 'http://myserver.mydomain.com:5601/wev/app/kibana#/dashboard/777182';
    expect(url_1.getDashboardIdFromUrl(url)).toEqual('777182');
    url =
    ...
    expect(url_1.getDashboardIdFromUrl(url)).toEqual('test');
    url = 'dashboard/test/?_g=(refreshInterval:';
    expect(url_1.getDashboardIdFromUrl(url)).toEqual('test');
    url = '/other-app/test/';
    expect(url_1.getDashboardIdFromUrl(url)).toEqual(undefined);
