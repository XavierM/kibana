...
class AdvancedSettingsVoiceAnnouncement extends react_1.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return (react_1.default.createElement(eui_1.EuiScreenReaderOnly, null,
            react_1.default.createElement("div", { role: "region", "aria-live": "polite" },
                react_1.default.createElement(eui_1.EuiDelayRender, null,
                    react_1.default.createElement(react_2.FormattedMessage, { id: "advancedSettings.voiceAnnouncement.searchResultScreenReaderMessage", defaultMessage: "You searched for {query}.\n                There {optionLenght, plural, one {is # option} other {are # options}}\n                in {sectionLenght, plural, one {# section} other {# sections}}", values: {
