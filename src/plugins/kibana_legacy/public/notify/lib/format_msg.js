...
const format_es_msg_1 = require("./format_es_msg");
const has = lodash_1.default.has;
/**
...
function formatMsg(err, source = '') {
    ...
    const esMsg = format_es_msg_1.formatESMsg(err);
    if (typeof err === 'string') {
        ...
        if (err.status === -1) {
            ...
            message += i18n_1.i18n.translate('kibana_legacy.notify.toaster.unavailableServerErrorMessage', {
            ...
            message += i18n_1.i18n.translate('kibana_legacy.notify.toaster.errorStatusMessage', {
