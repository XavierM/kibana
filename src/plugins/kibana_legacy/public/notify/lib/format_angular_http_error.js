...
function formatAngularHttpError(error) {
    ...
    if (error.status === -1) {
        ...
        return i18n_1.i18n.translate('kibana_legacy.notify.fatalError.unavailableServerErrorMessage', {
    ...
    return i18n_1.i18n.translate('kibana_legacy.notify.fatalError.errorStatusMessage', {
