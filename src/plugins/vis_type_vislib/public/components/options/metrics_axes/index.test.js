...
describe('MetricsAxisOptions component', () => {
    ...
    beforeEach(() => {
        ...
        chart = {
            ...mocks_1.seriesParam,
            type: collections_2.ChartTypes.AREA,
        };
        defaultProps = {
            ...
            stateParams: {
                valueAxes: [axis],
                seriesParams: [chart],
                categoryAxes: [mocks_1.categoryAxis],
                grid: { valueAxis: mocks_1.defaultValueAxisId },
            },
            setValue,
        };
    });
    it('should init with the default set of props', () => {
        const comp = enzyme_1.shallow(react_1.default.createElement(index_1.MetricsAxisOptions, Object.assign({}, defaultProps)));
        expect(comp).toMatchSnapshot();
    });
    describe('useEffect', () => {
        it('should update series when new agg is added', () => {
            const comp = enzyme_1.mount(react_1.default.createElement(index_1.MetricsAxisOptions, Object.assign({}, defaultProps)));
            comp.setProps({
        ...
        it('should update visType when one seriesParam', () => {
            const comp = enzyme_1.mount(react_1.default.createElement(index_1.MetricsAxisOptions, Object.assign({}, defaultProps)));
            expect(defaultProps.vis.type.type).toBe(collections_2.ChartTypes.AREA);
            comp.setProps({
                stateParams: {
                    ...defaultProps.stateParams,
                    seriesParams: [{ ...chart, type: collections_2.ChartTypes.LINE }],
                },
            });
            expect(defaultProps.vis.setState).toHaveBeenLastCalledWith({ type: collections_2.ChartTypes.LINE });
        });
        it('should set histogram visType when multiple seriesParam', () => {
            ...
            comp.setProps({
                stateParams: {
                    ...defaultProps.stateParams,
                    seriesParams: [chart, { ...chart, type: collections_2.ChartTypes.LINE }],
                },
            });
            expect(defaultProps.vis.setState).toHaveBeenLastCalledWith({ type: collections_2.ChartTypes.HISTOGRAM });
        });
    });
    ...
    it('should add value axis', () => {
        const comp = enzyme_1.shallow(react_1.default.createElement(index_1.MetricsAxisOptions, Object.assign({}, defaultProps)));
        comp.find(value_axes_panel_1.ValueAxesPanel).prop('addValueAxis')();
    ...
    describe('removeValueAxis', () => {
        ...
        it('should remove value axis', () => {
            const comp = enzyme_1.shallow(react_1.default.createElement(index_1.MetricsAxisOptions, Object.assign({}, defaultProps)));
            comp.find(value_axes_panel_1.ValueAxesPanel).prop('removeValueAxis')(axis);
    ...
    it('should update axis value when when category position chnaged', () => {
        const comp = enzyme_1.shallow(react_1.default.createElement(index_1.MetricsAxisOptions, Object.assign({}, defaultProps)));
        comp.find(category_axis_panel_1.CategoryAxisPanel).prop('onPositionChanged')(collections_1.Positions.LEFT);
        const updatedValues = [{ ...axis, name: 'BottomAxis-1', position: collections_1.Positions.BOTTOM }];
