...
exports.buildHierarchicalData = (table, { metric, buckets = [] }) => {
    let slices;
    const names = {};
    ...
    if (!buckets.length) {
        ...
        table.rows.forEach((row, rowIndex) => {
            ...
            buckets.forEach(bucket => {
                ...
                const bucketFormatter = services_1.getFormatService().deserialize(bucket.format);
