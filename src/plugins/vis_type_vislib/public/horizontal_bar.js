...
exports.createHorizontalBarVisTypeDefinition = (deps) => ({
    name: 'horizontal_bar',
    title: i18n_1.i18n.translate('visTypeVislib.horizontalBar.horizontalBarTitle', {
        defaultMessage: 'Horizontal Bar',
    }),
    icon: 'visBarHorizontal',
    description: i18n_1.i18n.translate('visTypeVislib.horizontalBar.horizontalBarDescription', {
            ...
            valueAxes: [
                {
                    ...
                    labels: {
                        show: true,
                        rotate: public_3.Rotates.ANGLED,
                        filter: true,
                        truncate: 100,
                    },
                    title: {
        ...
        schemas: new public_2.Schemas([
            {
                ...
                name: 'metric',
                title: i18n_1.i18n.translate('visTypeVislib.horizontalBar.metricTitle', {
            ...
            },
            {
                group: public_1.AggGroupNames.Metrics,
                name: 'radius',
                title: i18n_1.i18n.translate('visTypeVislib.horizontalBar.radiusTitle', {
            ...
            },
            {
                ...
                name: 'segment',
                title: i18n_1.i18n.translate('visTypeVislib.horizontalBar.segmentTitle', {
            ...
            },
            {
                group: public_1.AggGroupNames.Buckets,
                name: 'group',
                title: i18n_1.i18n.translate('visTypeVislib.horizontalBar.groupTitle', {
            ...
            },
            {
                group: public_1.AggGroupNames.Buckets,
                name: 'split',
                title: i18n_1.i18n.translate('visTypeVislib.horizontalBar.splitTitle', {
