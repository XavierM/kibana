...
class TelemetryService {
    constructor({ config, http, notifications, reportOptInStatusChange = true, }) {
        this.getCanChangeOptInStatus = () => {
            const allowChangingOptInStatus = this.config.allowChangingOptInStatus;
            return allowChangingOptInStatus;
        };
        this.getOptInStatusUrl = () => {
        ...
        this.setOptIn = async (optedIn) => {
            ...
            try {
                ...
                this.notifications.toasts.addError(err, {
                    title: i18n_1.i18n.translate('telemetry.optInErrorToastTitle', {
                        defaultMessage: 'Error',
                    }),
                    toastMessage: i18n_1.i18n.translate('telemetry.optInErrorToastText', {
        ...
        this.setUserHasSeenNotice = async () => {
            try {
                ...
                this.notifications.toasts.addError(error, {
                    title: i18n_1.i18n.translate('telemetry.optInNoticeSeenErrorTitle', {
                        defaultMessage: 'Error',
                    }),
                    toastMessage: i18n_1.i18n.translate('telemetry.optInNoticeSeenErrorToastText', {
         ...
         */
        this.reportOptInStatus = async (optInPayload) => {
