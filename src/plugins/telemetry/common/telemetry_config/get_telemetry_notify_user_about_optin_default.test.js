...
const get_telemetry_notify_user_about_optin_default_1 = require("./get_telemetry_notify_user_about_optin_default");
describe('getNotifyUserAboutOptInDefault: get a flag that describes if the user must be notified about optin default', () => {
    it('should return true when kibana has fresh defaults', () => {
        expect(get_telemetry_notify_user_about_optin_default_1.getNotifyUserAboutOptInDefault({
