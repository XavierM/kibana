...
let cachedLicense;
function fetchLicense(callCluster, local) {
 ...
 */
async function getLicenseFromLocalOrMaster(callCluster) {
...
exports.getLocalLicense = async (clustersDetails, { callCluster }) => {
