...
const authorization_provider_1 = require("./authorization_provider");
const toArray = (value) => Array.isArray(value) ? value : [value];
exports.WithPrivileges = ({ privileges: requiredPrivileges, children }) => {
    const { isLoading, privileges } = authorization_provider_1.useAuthorizationContext();
    ...
    const privilegesMissing = privilegesToArray.reduce((acc, [section, privilege]) => {
        ...
        else if (privileges.missingPrivileges[section] &&
