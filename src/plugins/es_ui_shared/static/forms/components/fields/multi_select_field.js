...
exports.MultiSelectField = ({ field, euiFieldProps = {}, ...rest }) => {
    ...
    return (react_1.default.createElement(eui_1.EuiFormRow, { label: field.label, helpText: typeof field.helpText === 'function' ? field.helpText() : field.helpText, error: errorMessage, isInvalid: isInvalid, fullWidth: true, "data-test-subj": rest['data-test-subj'], describedByIds: rest.idAria ? [rest.idAria] : undefined },
        react_1.default.createElement(eui_1.EuiSelectable, Object.assign({ allowExclusions: false, height: 300, onChange: options => {
                field.setValue(options);
            }, options: field.value, "data-test-subj": "select" }, euiFieldProps), (list, search) => (react_1.default.createElement(eui_1.EuiPanel, { paddingSize: "s", hasShadow: false },
            search,
            list)))));
};
