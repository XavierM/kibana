...
exports.ElasticsearchSqlHighlightRules = function () {
    // See https://www.elastic.co/guide/en/elasticsearch/reference/current/sql-commands.html
    const keywords = 'describe|between|in|like|not|and|or|desc|select|from|where|having|group|by|order' +
    ...
    const builtinFunctions = 'avg|count|first|first_value|last|last_value|max|min|sum|kurtosis|mad|percentile|percentile_rank|skewness' +
    ...
    const dataTypes = 'null|boolean|byte|short|integer|long|double|float|half_float|scaled_float|keyword|text|binary|date|ip|object|nested|time' +
...
oop.inherits(exports.ElasticsearchSqlHighlightRules, TextHighlightRules);
