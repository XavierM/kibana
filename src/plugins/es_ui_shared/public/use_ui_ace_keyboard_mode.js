...
react_1.default.createElement(react_1.default.Fragment, null,
    react_1.default.createElement(eui_1.EuiText, { size: "s" }, "Press Enter to start editing."),
    react_1.default.createElement(eui_1.EuiText, { size: "s" }, "When you\u2019re done, press Escape to stop editing.")));
function useUIAceKeyboardMode(aceTextAreaElement) {
    const overlayMountNode = react_1.useRef(null);
    const autoCompleteVisibleRef = react_1.useRef(false);
    react_1.useEffect(() => {
        ...
        const aceKeydownListener = (event) => {
            if (event.keyCode === eui_1.keyCodes.ESCAPE && !autoCompleteVisibleRef.current) {
                event.preventDefault();
        ...
        if (aceTextAreaElement) {
            ...
            ReactDOM.render(react_1.default.createElement(OverlayText, null), overlayMountNode.current);
