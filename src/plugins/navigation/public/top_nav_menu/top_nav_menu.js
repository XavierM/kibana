...
function TopNavMenu(props) {
    ...
    function renderLayout() {
        ...
        return (react_1.default.createElement("span", { className: "kbnTopNavMenu__wrapper" },
            react_1.default.createElement(eui_1.EuiFlexGroup, { "data-test-subj": "top-nav", justifyContent: "flexStart", alignItems: "center", gutterSize: "none", className: className, responsive: false }, renderItems()),
            renderSearchBar()));
    }
    return renderLayout();
}
