...
function TopNavMenuItem(props) {
    ...
    const btn = props.emphasize ? (react_1.default.createElement(eui_2.EuiButton, Object.assign({}, commonButtonProps, { size: "s", fill: true }), lodash_1.capitalize(props.label || props.id))) : (react_1.default.createElement(eui_1.EuiButtonEmpty, Object.assign({}, commonButtonProps, { size: "xs" }), lodash_1.capitalize(props.label || props.id)));
