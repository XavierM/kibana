...
describe('ExpressionType', () => {
    ...
    describe('from()', () => {
        test('can cast from any type specified in definition', () => {
            const type = new expression_type_1.ExpressionType(exports.boolean);
        ...
        test('throws when casting from type that is not supported', async () => {
            ...
            expect(() => type.from(emptyDatatableValue, {})).toThrowErrorMatchingInlineSnapshot(`"Can not cast 'boolean' from datatable"`);
        });
    });
    describe('to()', () => {
        ...
        test('throws when casting to type that is not supported', async () => {
            ...
            expect(() => type.to(emptyDatatableValue, 'number', {})).toThrowErrorMatchingInlineSnapshot(`"Can not cast object of type 'datatable' using 'boolean'"`);
        });
    });
});
