...
const createExecution = (expression = 'foo bar=123', context = {}) => {
...
describe('ExecutionContract', () => {
    test('can instantiate', () => {
        ...
        const contract = new execution_contract_1.ExecutionContract(execution);
        expect(contract).toBeInstanceOf(execution_contract_1.ExecutionContract);
    });
