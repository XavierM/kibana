...
describe('font', () => {
    const fn = utils_1.functionWrapper(font_1.font);
    ...
    describe('args', () => {
        ...
        describe('family', () => {
            ...
            it(`defaults to "${fonts_1.openSans.value}"`, () => {
                const result = fn(null);
                expect(result.spec.fontFamily).toBe(`"${fonts_1.openSans.value}"`);
                expect(result.css).toContain(`font-family:"${fonts_1.openSans.value}"`);
            });
        });
        describe('color', () => {
            it('sets font color', () => {
