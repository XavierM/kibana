...
exports.configSchema = config_schema_1.schema.object({
    ...
    ui: config_schema_1.schema.object({ enabled: config_schema_1.schema.boolean({ defaultValue: false }) }),
    graphiteUrls: config_schema_1.schema.maybe(config_schema_1.schema.arrayOf(config_schema_1.schema.string())),
}, 
