...
const plugin_services_1 = require("./plugin_services");
const public_1 = require("../../../data/public");
function getArgValueSuggestions() {
    const indexPatterns = plugin_services_1.getIndexPatterns();
    const savedObjectsClient = plugin_services_1.getSavedObjectsClient();
    async function getIndexPattern(functionArgs) {
        ...
        const indexPatternTitle = lodash_1.get(indexPatternArg, 'value.text');
        ...
        const indexPatternSavedObject = savedObjects.find(({ attributes }) => attributes.title === indexPatternTitle);
            ...
            async metric(partial, functionArgs) {
                ...
                return indexPattern.fields
                    ...
                    return (field.aggregatable &&
                        ...
                        !public_1.indexPatterns.isNestedField(field));
                })
                    .map(field => {
