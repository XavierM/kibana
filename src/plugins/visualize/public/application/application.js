...
exports.renderApp = (element, appBasePath, deps) => {
    if (!angularModuleInstance) {
        ...
        legacy_app_1.initVisualizeApp(angularModuleInstance, deps);
    }
...
function createLocalAngularModule(core, navigation) {
    ...
    const visualizeAngularModule = angular_1.default.module(moduleName, [
...
function createLocalTopNavModule(navigation) {
    angular_1.default
        ...
        .directive('kbnTopNav', public_1.createTopNavDirective)
        .directive('kbnTopNavHelper', public_1.createTopNavHelper(navigation.ui));
}
