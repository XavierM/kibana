...
function getLandingBreadcrumbs() {
    return [
        {
            text: i18n_1.i18n.translate('visualize.listing.breadcrumb', {
                defaultMessage: 'Visualize',
            }),
            href: `#${visualize_constants_1.VisualizeConstants.LANDING_PAGE_PATH}`,
        },
    ];
}
...
function getWizardStep1Breadcrumbs() {
    return [
        ...
        {
            text: i18n_1.i18n.translate('visualize.wizard.step1Breadcrumb', {
...
function getWizardStep2Breadcrumbs() {
    return [
        ...getLandingBreadcrumbs(),
        {
            text: i18n_1.i18n.translate('visualize.wizard.step2Breadcrumb', {
                defaultMessage: 'Create',
            }),
        },
    ];
...
function getCreateBreadcrumbs() {
    return [
        ...getLandingBreadcrumbs(),
        {
            text: i18n_1.i18n.translate('visualize.editor.createBreadcrumb', {
                defaultMessage: 'Create',
            }),
        },
    ];
