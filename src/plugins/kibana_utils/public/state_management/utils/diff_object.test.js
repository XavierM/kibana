...
describe('diff_object', () => {
    ...
    test('should ignore functions', () => {
        ...
        diff_object_1.applyDiff(target, source);
    ...
    test('should only change keys that actually changed', () => {
        ...
        const source = { obj: lodash_1.cloneDeep(obj), message: 'test' };
        diff_object_1.applyDiff(target, source);
