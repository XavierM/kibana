...
describe('new Defer()', () => {
    test('has .promise Promise object', () => {
        expect(new defer_1.Defer().promise).toBeInstanceOf(Promise);
    });
    test('has .resolve() method', () => {
        expect(typeof new defer_1.Defer().resolve).toBe('function');
    });
    test('has .reject() method', () => {
        expect(typeof new defer_1.Defer().reject).toBe('function');
    });
