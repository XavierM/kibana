...
class PanelNotFoundError extends Error {
    constructor() {
        super(i18n_1.i18n.translate('embeddableApi.errors.paneldoesNotExist', {
            defaultMessage: 'Panel not found',
        }));
        this.code = 'PANEL_NOT_FOUND';
    }
}
exports.PanelNotFoundError = PanelNotFoundError;
class EmbeddableFactoryNotFoundError extends Error {
    constructor(type) {
        super(i18n_1.i18n.translate('embeddableApi.errors.embeddableFactoryNotFound', {
        ...
        this.code = 'EMBEDDABLE_FACTORY_NOT_FOUND';
    }
}
