...
class EmbeddablePanel extends react_1.default.Component {
    constructor(props) {
        ...
        this.getActionContextMenuPanel = async () => {
            let actions = await this.props.getActions(triggers_1.CONTEXT_MENU_TRIGGER, {
            ...
            const extraActions = [
                ...
                new actions_1.EditPanelAction(this.props.getEmbeddableFactory, this.props.application),
            ];
    ...
    UNSAFE_componentWillMount() {
        ...
        this.subscription = embeddable.getInput$().subscribe(async () => {
            if (this.mounted) {
                this.setState({
                    viewMode: embeddable.getInput().viewMode ? embeddable.getInput().viewMode : types_1.ViewMode.EDIT,
                });
                this.refreshBadges();
            }
        });
