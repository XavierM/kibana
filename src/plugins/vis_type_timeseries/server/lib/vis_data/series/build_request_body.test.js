...
const build_request_body_1 = require("./build_request_body");
...
describe('buildRequestBody(req)', () => {
    test('returns a valid body', () => {
        ...
        const doc = build_request_body_1.buildRequestBody({ payload: body }, panel, series, config, indexPatternObject, capabilities);
        expect(doc).toEqual({
            size: 0,
            query: {
                bool: {
