...
const create_batched_function_1 = require("../create_batched_function");
describe('createBatchedFunction', () => {
    test('calls onCall every time fn is called, calls onBatch once flushOnMaxItems reached', async () => {
        ...
        const onCall = jest.fn(() => [1, 2]);
        const [fn] = create_batched_function_1.createBatchedFunction({
            onBatch,
            onCall,
            flushOnMaxItems: 2,
            maxItemAge: 10,
