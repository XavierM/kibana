...
describe('createOrUpgradeSavedConfig()', () => {
    ...
    beforeAll(async function () {
        servers = kbn_server_1.createTestServers({
            adjustTimeout: t => {
                jest.setTimeout(t);
            },
        });
        ...
        savedObjectsClient = savedObjects.getScopedSavedObjectsClient(http_server_mocks_1.httpServerMock.createKibanaRequest());
