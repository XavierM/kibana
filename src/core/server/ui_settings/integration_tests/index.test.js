...
const doc_exists_1 = require("./doc_exists");
const doc_missing_1 = require("./doc_missing");
const doc_missing_and_index_read_only_1 = require("./doc_missing_and_index_read_only");
describe('uiSettings/routes', function () {
    ...
    beforeAll(lib_1.startServers);
    /* eslint-disable jest/valid-describe */
    describe('doc missing', doc_missing_1.docMissingSuite);
    describe('doc missing and index readonly', doc_missing_and_index_read_only_1.docMissingAndIndexReadOnlySuite);
    describe('doc exists', doc_exists_1.docExistsSuite);
    /* eslint-enable jest/valid-describe */
    afterAll(lib_1.stopServers);
});
