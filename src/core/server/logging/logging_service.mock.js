...
const logger_mock_1 = require("./logger.mock");
const createLoggingServiceMock = () => {
    const mockLog = logger_mock_1.loggerMock.create();
...
const collectLoggingServiceMock = (loggerFactory) => {
    const mockLog = loggerFactory.get();
    return {
...
const clearLoggingServiceMock = (loggerFactory) => {
    const mockedLoggerFactory = loggerFactory;
