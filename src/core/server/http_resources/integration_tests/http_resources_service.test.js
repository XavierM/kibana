    ...
    describe('register', () => {
        ...
        describe('renderAnonymousCoreApp', () => {
            it('renders core application', async () => {
                ...
                resources.register({ path: '/render-core', validate: false }, (context, req, res) => res.renderAnonymousCoreApp());
                await root.start();
        ...
        `;
                resources.register({ path: '/render-html', validate: false }, (context, req, res) => res.renderHtml({ body: htmlBody }));
                await root.start();
            ...
            it('renders javascript', async () => {
                ...
                resources.register({ path: '/render-js', validate: false }, (context, req, res) => res.renderJs({ body: jsBody }));
                await root.start();
        ...
        `;
            ...
            it('can attach headers, except the CSP & "content-type" headers', async () => {
                ...
                const router = http.createRouter('');
                const resources = httpResources.createRegistrar(router);
                resources.register({ path: '/render-core', validate: false }, (context, req, res) => res.renderHtml({
            ...
            it('can adjust route config', async () => {
                ...
                resources.register({ path: '/render-js-with-param/{id}', validate }, (context, req, res) => res.renderJs({ body: `window.alert(${req.params.id});` }));
                await root.start();
