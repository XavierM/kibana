...
class OpsMetricsCollector {
    constructor(server) {
        this.processCollector = new collectors_1.ProcessMetricsCollector();
        this.osCollector = new collectors_1.OsMetricsCollector();
        this.serverCollector = new collectors_1.ServerMetricsCollector(server);
    }
    async collect() {
