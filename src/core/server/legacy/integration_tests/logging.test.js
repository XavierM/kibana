...
const utils_1 = require("../../logging/integration_tests/utils");
function createRoot(legacyLoggingConfig = {}) {
    ...
    describe('compatibility', () => {
        describe('uses configured loggers', () => {
            ...
            it('when context matches', async () => {
                ...
                const loggedString = utils_1.getPlatformLogsFromMock(mockConsoleLog);
        ...
        `);
            ...
            it('falls back to the root legacy logger otherwise', async () => {
                ...
                const loggedString = utils_1.getLegacyPlatformLogsFromMock(mockStdout);
                expect(loggedString).toMatchInlineSnapshot(`
          Array [
        ...
        describe('logging config respects legacy logging settings', () => {
            ...
            it('"silent": true', async () => {
                ...
                expect(utils_1.getPlatformLogsFromMock(mockConsoleLog)).toMatchInlineSnapshot(`
          Array [
        ...
        `);
                ...
                legacyPlatformLogger.error('error');
                expect(mockStdout).toHaveBeenCalledTimes(1);
                expect(utils_1.getLegacyPlatformLogsFromMock(mockStdout)).toMatchInlineSnapshot(`
          Array [
