...
describe('mergeVars', () => {
    it('merges two objects together', () => {
        ...
        expect(merge_vars_1.mergeVars(first, second)).toEqual({
            name: 'value',
            canFoo: true,
            nested: {
                anotherVariable: 'ok',
    ...
    it('does not mutate the source objects', () => {
        ...
        merge_vars_1.mergeVars(first, second, third, fourth);
    ...
    it('merges multiple objects together with precedence increasing from left-to-right', () => {
        ...
        expect(merge_vars_1.mergeVars(first, second, third, fourth)).toEqual({
            var1: 'fourth',
            var2: 'third',
            var3: 'second',
            var4: 'first',
    ...
    it('combines entries within "uiCapabilities"', () => {
        ...
        expect(merge_vars_1.mergeVars(first, second, third)).toEqual({
            name: 'value',
            canFoo: true,
            uiCapabilities: {
                firstCapability: 'ok',
