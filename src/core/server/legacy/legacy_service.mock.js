...
const createDiscoverPluginsMock = () => ({
    pluginSpecs: [],
    uiExports: {
        savedObjectSchemas: {},
        savedObjectMappings: [],
...
const createLegacyConfigMock = () => ({
    get: jest.fn(),
    has: jest.fn(),
    set: jest.fn(),
});
exports.legacyServiceMock = {
    create: createLegacyServiceMock,
    createSetupContract: (deps) => createLegacyServiceMock().setup(deps),
