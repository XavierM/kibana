...
const router_mock_1 = require("../http/router/router.mock");
const capabilities_service_1 = require("./capabilities_service");
...
describe('CapabilitiesService', () => {
    ...
    beforeEach(() => {
        ...
        router = router_mock_1.mockRouter.create();
        http.createRouter.mockReturnValue(router);
        service = new capabilities_service_1.CapabilitiesService(core_context_mock_1.mockCoreContext.create());
    });
    describe('#setup()', () => {
        beforeEach(() => {
        ...
        it('allows to register a capabilities provider', async () => {
            ...
            expect(await start.resolveCapabilities({})).toMatchInlineSnapshot(`
        Object {
          "catalogue": Object {
            "myPlugin": true,
          },
