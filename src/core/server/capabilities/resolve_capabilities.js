...
exports.getCapabilitiesResolver = (capabilities, switchers) => async (request, applications) => {
    return exports.resolveCapabilities(capabilities(), switchers(), request, applications);
};
exports.resolveCapabilities = async (capabilities, switchers, request, applications) => {
    const mergedCaps = lodash_1.cloneDeep({
        ...capabilities,
