...
const createRegistryMock = () => {
    ...
    mock.isNamespaceAgnostic.mockImplementation((type) => type === 'global');
    mock.isSingleNamespace.mockImplementation((type) => type !== 'global' && type !== 'shared');
    mock.isMultiNamespace.mockImplementation((type) => type === 'shared');
    mock.isImportableAndExportable.mockReturnValue(true);
    return mock;
};
exports.typeRegistryMock = {
