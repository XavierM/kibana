...
describe('docValidator', () => {
    test('does not run validators that have no application to the doc', () => {
        ...
        expect(() => index_1.docValidator(validators)({ type: 'shoo', bar: 'hi' })).not.toThrow();
    });
    test('validates the doc type', () => {
        ...
        expect(() => index_1.docValidator(validators)({ type: 'foo' })).toThrow(/Boom!/);
    });
    test('validates various props', () => {
        ...
        index_1.docValidator(validators)({ type: 'a', b: 'foo' });
