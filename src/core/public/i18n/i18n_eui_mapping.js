...
exports.euiContextMapping = {
    ...
    'euiBreadcrumbs.collapsedBadge.ariaLabel': i18n_1.i18n.translate('core.euiBreadcrumbs.collapsedBadge.ariaLabel', {
        defaultMessage: 'Show all breadcrumbs',
        description: 'Displayed when one or more breadcrumbs are hidden.',
    }),
    'euiCardSelect.select': i18n_1.i18n.translate('core.euiCardSelect.select', {
        defaultMessage: 'Select',
        description: 'Displayed button text when a card option can be selected.',
    }),
    'euiCardSelect.selected': i18n_1.i18n.translate('core.euiCardSelect.selected', {
        defaultMessage: 'Selected',
        description: 'Displayed button text when a card option is selected.',
    }),
    'euiCardSelect.unavailable': i18n_1.i18n.translate('core.euiCardSelect.unavailable', {
    ...
    'euiColorPicker.screenReaderAnnouncement': i18n_1.i18n.translate('core.euiColorPicker.screenReaderAnnouncement', {
    ...
    'euiColorPicker.swatchAriaLabel': ({ swatch }) => i18n_1.i18n.translate('core.euiColorPicker.swatchAriaLabel', {
    ...
    'euiColorStopThumb.removeLabel': i18n_1.i18n.translate('core.euiColorStopThumb.removeLabel', {
        defaultMessage: 'Remove this stop',
        description: 'Label accompanying a button whose action will remove the color stop',
    }),
    'euiColorStopThumb.screenReaderAnnouncement': i18n_1.i18n.translate('core.euiColorStopThumb.screenReaderAnnouncement', {
    ...
    'euiColorStops.screenReaderAnnouncement': ({ label, readOnly, disabled }) => i18n_1.i18n.translate('core.euiColorStops.screenReaderAnnouncement', {
    ...
    'euiColumnSelector.hideAll': i18n_1.i18n.translate('core.euiColumnSelector.hideAll', {
        defaultMessage: 'Hide all',
    }),
    'euiColumnSelector.selectAll': i18n_1.i18n.translate('core.euiColumnSelector.selectAll', {
        defaultMessage: 'Show all',
    }),
    'euiColumnSorting.clearAll': i18n_1.i18n.translate('core.euiColumnSorting.clearAll', {
        defaultMessage: 'Clear sorting',
    }),
    'euiColumnSorting.emptySorting': i18n_1.i18n.translate('core.euiColumnSorting.emptySorting', {
        defaultMessage: 'Currently no fields are sorted',
    }),
    'euiColumnSorting.pickFields': i18n_1.i18n.translate('core.euiColumnSorting.pickFields', {
        defaultMessage: 'Pick fields to sort by',
    }),
    'euiColumnSorting.sortFieldAriaLabel': i18n_1.i18n.translate('core.euiColumnSorting.sortFieldAriaLabel', {
        defaultMessage: 'Sort by:',
    }),
    'euiColumnSortingDraggable.activeSortLabel': i18n_1.i18n.translate('core.euiColumnSortingDraggable.activeSortLabel', {
        defaultMessage: 'is sorting this data grid',
    }),
    'euiColumnSortingDraggable.defaultSortAsc': i18n_1.i18n.translate('core.euiColumnSortingDraggable.defaultSortAsc', {
        defaultMessage: 'A-Z',
        description: 'Ascending sort label',
    }),
    'euiColumnSortingDraggable.defaultSortDesc': i18n_1.i18n.translate('core.euiColumnSortingDraggable.defaultSortDesc', {
        defaultMessage: 'Z-A',
        description: 'Descending sort label',
    }),
    'euiColumnSortingDraggable.removeSortLabel': i18n_1.i18n.translate('core.euiColumnSortingDraggable.removeSortLabel', {
        defaultMessage: 'Remove from data grid sort:',
    }),
    'euiColumnSortingDraggable.toggleLegend': i18n_1.i18n.translate('core.euiColumnSortingDraggable.toggleLegend', {
    ...
    'euiCommonlyUsedTimeRanges.legend': i18n_1.i18n.translate('core.euiCommonlyUsedTimeRanges.legend', {
        defaultMessage: 'Commonly used',
    }),
    'euiDataGrid.screenReaderNotice': i18n_1.i18n.translate('core.euiDataGrid.screenReaderNotice', {
        defaultMessage: 'Cell contains interactive content.',
    }),
    'euiDataGridCell.expandButtonTitle': i18n_1.i18n.translate('core.euiDataGridCell.expandButtonTitle', {
        defaultMessage: 'Click or hit enter to interact with cell content',
    }),
    'euiDataGridSchema.booleanSortTextAsc': i18n_1.i18n.translate('core.euiDataGridSchema.booleanSortTextAsc', {
        defaultMessage: 'True-False',
        description: 'Ascending boolean label',
    }),
    'euiDataGridSchema.booleanSortTextDesc': i18n_1.i18n.translate('core.euiDataGridSchema.booleanSortTextDesc', {
        defaultMessage: 'False-True',
        description: 'Descending boolean label',
    }),
    'euiDataGridSchema.currencySortTextAsc': i18n_1.i18n.translate('core.euiDataGridSchema.currencySortTextAsc', {
        defaultMessage: 'Low-High',
        description: 'Ascending currency label',
    }),
    'euiDataGridSchema.currencySortTextDesc': i18n_1.i18n.translate('core.euiDataGridSchema.currencySortTextDesc', {
        defaultMessage: 'High-Low',
        description: 'Descending currency label',
    }),
    'euiDataGridSchema.dateSortTextAsc': i18n_1.i18n.translate('core.euiDataGridSchema.dateSortTextAsc', {
        defaultMessage: 'New-Old',
        description: 'Ascending date label',
    }),
    'euiDataGridSchema.dateSortTextDesc': i18n_1.i18n.translate('core.euiDataGridSchema.dateSortTextDesc', {
        defaultMessage: 'Old-New',
        description: 'Descending date label',
    }),
    'euiDataGridSchema.numberSortTextAsc': i18n_1.i18n.translate('core.euiDataGridSchema.numberSortTextAsc', {
        defaultMessage: 'Low-High',
        description: 'Ascending number label',
    }),
    'euiDataGridSchema.numberSortTextDesc': i18n_1.i18n.translate('core.euiDataGridSchema.numberSortTextDesc', {
        defaultMessage: 'High-Low',
        description: 'Descending number label',
    }),
    'euiDataGridSchema.jsonSortTextAsc': i18n_1.i18n.translate('core.euiDataGridSchema.jsonSortTextAsc', {
        defaultMessage: 'Small-Large',
        description: 'Ascending size label',
    }),
    'euiDataGridSchema.jsonSortTextDesc': i18n_1.i18n.translate('core.euiDataGridSchema.jsonSortTextDesc', {
        defaultMessage: 'Large-Small',
        description: 'Descending size label',
    }),
    'euiFilterButton.filterBadge': ({ count, hasActiveFilters }) => i18n_1.i18n.translate('core.euiFilterButton.filterBadge', {
    ...
    'euiHue.label': i18n_1.i18n.translate('core.euiHue.label', {
        defaultMessage: 'Select the HSV color mode "hue" value',
    }),
    'euiImage.closeImage': ({ alt }) => i18n_1.i18n.translate('core.euiImage.closeImage', {
        defaultMessage: 'Close full screen {alt} image',
        values: { alt },
    }),
    'euiImage.openImage': ({ alt }) => i18n_1.i18n.translate('core.euiImage.openImage', {
        defaultMessage: 'Open full screen {alt} image',
        values: { alt },
    }),
    'euiLink.external.ariaLabel': i18n_1.i18n.translate('core.euiLink.external.ariaLabel', {
    ...
    'euiQuickSelect.applyButton': i18n_1.i18n.translate('core.euiQuickSelect.applyButton', {
        defaultMessage: 'Apply',
    }),
    'euiQuickSelect.fullDescription': ({ timeTense, timeValue, timeUnit }) => i18n_1.i18n.translate('core.euiQuickSelect.fullDescription', {
        defaultMessage: 'Currently set to {timeTense} {timeValue} {timeUnit}.',
        values: { timeTense, timeValue, timeUnit },
    }),
    'euiQuickSelect.legendText': i18n_1.i18n.translate('core.euiQuickSelect.legendText', {
        defaultMessage: 'Quick select a time range',
    }),
    'euiQuickSelect.nextLabel': i18n_1.i18n.translate('core.euiQuickSelect.nextLabel', {
        defaultMessage: 'Next time window',
    }),
    'euiQuickSelect.previousLabel': i18n_1.i18n.translate('core.euiQuickSelect.previousLabel', {
        defaultMessage: 'Previous time window',
    }),
    'euiQuickSelect.quickSelectTitle': i18n_1.i18n.translate('core.euiQuickSelect.quickSelectTitle', {
        defaultMessage: 'Quick select',
    }),
    'euiQuickSelect.tenseLabel': i18n_1.i18n.translate('core.euiQuickSelect.tenseLabel', {
        defaultMessage: 'Time tense',
    }),
    'euiQuickSelect.unitLabel': i18n_1.i18n.translate('core.euiQuickSelect.unitLabel', {
        defaultMessage: 'Time unit',
    }),
    'euiQuickSelect.valueLabel': i18n_1.i18n.translate('core.euiQuickSelect.valueLabel', {
        defaultMessage: 'Time value',
    }),
    'euiRefreshInterval.fullDescription': ({ optionValue, optionText }) => i18n_1.i18n.translate('core.euiRefreshInterval.fullDescription', {
        defaultMessage: 'Currently set to {optionValue} {optionText}.',
        values: { optionValue, optionText },
    }),
    'euiRefreshInterval.legend': i18n_1.i18n.translate('core.euiRefreshInterval.legend', {
        defaultMessage: 'Refresh every',
    }),
    'euiRefreshInterval.start': i18n_1.i18n.translate('core.euiRefreshInterval.start', {
        defaultMessage: 'Start',
    }),
    'euiRefreshInterval.stop': i18n_1.i18n.translate('core.euiRefreshInterval.stop', {
        defaultMessage: 'Stop',
    }),
    'euiRelativeTab.fullDescription': ({ unit }) => i18n_1.i18n.translate('core.euiRelativeTab.fullDescription', {
        defaultMessage: 'The unit is changeable. Currently set to {unit}.',
        values: { unit },
    }),
    'euiRelativeTab.relativeDate': ({ position }) => i18n_1.i18n.translate('core.euiRelativeTab.relativeDate', {
        defaultMessage: '{position} date',
        values: { position },
    }),
    'euiRelativeTab.roundingLabel': ({ unit }) => i18n_1.i18n.translate('core.euiRelativeTab.roundingLabel', {
        defaultMessage: 'Round to the {unit}',
        values: { unit },
    }),
    'euiRelativeTab.unitInputLabel': i18n_1.i18n.translate('core.euiRelativeTab.unitInputLabel', {
        defaultMessage: 'Relative time span',
    }),
    'euiSaturation.roleDescription': i18n_1.i18n.translate('core.euiSaturation.roleDescription', {
        defaultMessage: 'HSV color mode saturation and value selection',
    }),
    'euiSaturation.screenReaderAnnouncement': i18n_1.i18n.translate('core.euiSaturation.screenReaderAnnouncement', {
    ...
    'euiStat.loadingText': i18n_1.i18n.translate('core.euiStat.loadingText', {
        defaultMessage: 'Statistic is loading',
    }),
    'euiStep.ariaLabel': ({ status }) => i18n_1.i18n.translate('core.euiStep.ariaLabel', {
    ...
    'euiStyleSelector.buttonText': i18n_1.i18n.translate('core.euiStyleSelector.buttonText', {
        defaultMessage: 'Density',
    }),
    'euiSuperDatePicker.showDatesButtonLabel': i18n_1.i18n.translate('core.euiSuperDatePicker.showDatesButtonLabel', {
    ...
    'euiSuperUpdateButton.cannotUpdateTooltip': i18n_1.i18n.translate('core.euiSuperUpdateButton.cannotUpdateTooltip', {
        defaultMessage: 'Cannot update',
        description: "Displayed in a tooltip when updates can't happen",
    }),
    'euiSuperUpdateButton.clickToApplyTooltip': i18n_1.i18n.translate('core.euiSuperUpdateButton.clickToApplyTooltip', {
        defaultMessage: 'Click to apply',
        description: "Displayed in a tooltip when there are changes that haven't been applied",
    }),
    'euiSuperUpdateButton.refreshButtonLabel': i18n_1.i18n.translate('core.euiSuperUpdateButton.refreshButtonLabel', {
        defaultMessage: 'Refresh',
        description: 'Displayed in a button that refreshes based on date picked',
    }),
    'euiSuperUpdateButton.updatingButtonLabel': i18n_1.i18n.translate('core.euiSuperUpdateButton.updatingButtonLabel', {
        defaultMessage: 'Updating',
        description: 'Displayed in a button that refreshes when updates are happening',
    }),
    'euiSuperUpdateButton.updateButtonLabel': i18n_1.i18n.translate('core.euiSuperUpdateButton.updateButtonLabel', {
    ...
    'euiTablePagination.rowsPerPageOption': ({ rowsPerPage }) => i18n_1.i18n.translate('core.euiTablePagination.rowsPerPageOption', {
    ...
    'euiTreeView.ariaLabel': ({ nodeLabel, ariaLabel }) => i18n_1.i18n.translate('core.euiTreeView.ariaLabel', {
        defaultMessage: '{nodeLabel} child of {ariaLabel}',
        values: { nodeLabel, ariaLabel },
    }),
    'euiTreeView.listNavigationInstructions': i18n_1.i18n.translate('core.euiTreeView.listNavigationInstructions', {
