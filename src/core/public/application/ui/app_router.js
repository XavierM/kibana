...
exports.AppRouter = ({ history, mounters, setAppLeaveHandler, appStatuses$, }) => {
    ...
    return (react_1.default.createElement(react_router_dom_1.Router, { history: history },
        react_1.default.createElement(react_router_dom_1.Switch, null,
            ...
            mounter.appBasePath.startsWith('/app')
                ? []
                : [
                    react_1.default.createElement(react_router_dom_1.Route, { key: mounter.appRoute, path: mounter.appRoute, render: ({ match: { url } }) => (react_1.default.createElement(app_container_1.AppContainer, Object.assign({ appPath: url, appStatus: appStatuses.get(appId) ?? types_1.AppStatus.inaccessible, createScopedHistory: createScopedHistory }, { appId, mounter, setAppLeaveHandler }))) }),
                ]),
            react_1.default.createElement(react_router_dom_1.Route, { path: "/app/:appId", render: ({ match: { params: { appId }, url, }, }) => {
                    ...
                    return (react_1.default.createElement(app_container_1.AppContainer, Object.assign({ appPath: url, appId: id, appStatus: appStatuses.get(id) ?? types_1.AppStatus.inaccessible, createScopedHistory: createScopedHistory }, { mounter, setAppLeaveHandler })));
                } }))));
};
