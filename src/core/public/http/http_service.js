...
const anonymous_paths_service_1 = require("./anonymous_paths_service");
const loading_count_service_1 = require("./loading_count_service");
const fetch_1 = require("./fetch");
/** @internal */
class HttpService {
    constructor() {
        this.anonymousPaths = new anonymous_paths_service_1.AnonymousPathsService();
        this.loadingCount = new loading_count_service_1.LoadingCountService();
    }
    setup({ injectedMetadata, fatalErrors }) {
        const kibanaVersion = injectedMetadata.getKibanaVersion();
        const basePath = new base_path_1.BasePath(injectedMetadata.getBasePath(), injectedMetadata.getServerBasePath());
        const fetchService = new fetch_1.Fetch({ basePath, kibanaVersion });
