...
describe('HeaderBreadcrumbs', () => {
    it('renders updates to the breadcrumbs$ observable', () => {
        const breadcrumbs$ = new Rx.Subject();
        const wrapper = enzyme_1.mount(react_1.default.createElement(header_breadcrumbs_1.HeaderBreadcrumbs, { "breadcrumbs$": breadcrumbs$ }));
