...
const nav_controls_service_1 = require("./nav_controls_service");
const operators_1 = require("rxjs/operators");
describe('RecentlyAccessed#start()', () => {
    const getStart = () => {
        return new nav_controls_service_1.NavControlsService().start();
    };
    describe('left side', () => {
        it('allows registration', async () => {
            ...
            expect(await navControls
                .getLeft$()
                .pipe(operators_1.take(1))
                .toPromise()).toEqual([nc]);
        });
