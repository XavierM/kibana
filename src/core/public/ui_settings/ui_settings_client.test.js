...
function setup(options = {}) {
    ...
    const client = new ui_settings_client_1.UiSettingsClient({
        defaults,
        initialSettings,
        api: {
            batchSet,
...
describe('#get$', () => {
    it('emits the current value when called', async () => {
        ...
        const values = await client
            .get$('dateFormat')
            .pipe(operators_1.take(1), operators_1.toArray())
            .toPromise();
...
`);
    ...
    it('emits the new value when it changes', async () => {
        ...
        const values = await client
            .get$('dateFormat')
            .pipe(operators_1.take(2), operators_1.toArray())
            .toPromise();
    ...
    it('emits the default override if no value is set, or if the value is removed', async () => {
        ...
        const values = await client
            ...
            .pipe(operators_1.take(3), operators_1.toArray())
            .toPromise();
